...
namespace TH.BaseClass
{
    public partial class GetBaseData
    {
        ...
        /// </summary>
        /// <returns></returns>
        public string GetBarCode(DateTime dDate, int lMaxID)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public string GetBarCodeBox(DateTime dDate, int lMaxID)
        {
        ...
        public string GetSerialNO(string sMaxSerialNO, string sInvCode, int iRightLength)
        {
            ...
            else
            {
                ...
                int l = BaseFunction.Returnint(sMaxSerialNO.Substring(9));
                l += 1;

                double l2 = Math.Pow(10, (iRightLength));
                if (l == BaseFunction.Returnint(l2))
                {
