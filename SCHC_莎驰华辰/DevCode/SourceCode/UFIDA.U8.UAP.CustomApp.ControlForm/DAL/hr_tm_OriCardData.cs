...
namespace TH.DAL
{
    ...
    public partial class hr_tm_OriCardData
    {
        ...
        /// 增加一条数据
        /// </summary>
        public string Add(TH.Model.hr_tm_OriCardData model)
        {
            ...
            if (model.uRecordId != null)
            {
                ...
                strSql2.Append("'" + model.uRecordId + "',");
            }
            ...
            if (model.cLongitude != null)
            {
                strSql1.Append("cLongitude,");
                strSql2.Append("'" + model.cLongitude + "',");
            }
            ...
            strSql.Append("insert into hr_tm_OriCardData(");
