    ...
    <div class="container" style="width: 100%">
            ...
            <asp:Panel runat="server" ID="divSel" Width="100%" CssClass="panel">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownListS1" runat="server" CssClass="form-control" DataSourceID="ObjectDataSource2"
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="iID" EnableDefaultAppearance="False"
            ...
            <Columns>
                ...
                <dx:GridViewDataComboBoxColumn FieldName="S1" VisibleIndex="4" ShowInCustomizationForm="true">
                    <EditItemTemplate>
                        <FormatControls:DropDownList ID="DropDownList1" DataTextField="iText" DataValueField="iID" 
                            iFlag="2" runat="server" Value='<%# Bind("S1") %>' />
                    </EditItemTemplate>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" TypeName="SPData" SelectMethod="Get"
        ...
        <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetInventory"
            TypeName="PublicData">
            <SelectParameters>
            </SelectParameters>
        </asp:ObjectDataSource>
        ...
        <dx:ASPxGridView ID="ASPxGridView2" runat="server" KeyFieldName="iID" EnableDefaultAppearance="False"
            DataSourceID="ObjectDataSource3" AutoGenerateColumns="False" Width="100%" CssClass="table">
            <Columns>
                <dx:GridViewDataTextColumn FieldName="S1" VisibleIndex="1" Caption="存货编码">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="S2" VisibleIndex="2" Caption="名称">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="S3" VisibleIndex="4"  Caption="规格型号">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="S4" VisibleIndex="5"  Caption="U/M">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="S5" VisibleIndex="6"   Caption="设备编号">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="D1" VisibleIndex="7"   Caption="安全库存">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="数量" VisibleIndex="8"   Caption="数量">
                </dx:GridViewDataTextColumn>
...
<asp:ObjectDataSource ID="ObjectDataSource3" runat="server" TypeName="SPData" SelectMethod="Get2">
            <SelectParameters>
            </SelectParameters>
