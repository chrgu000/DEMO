    ...
    <div class="container" style="width: 100%">
            ...
            <asp:Panel runat="server" ID="divSel" Width="100%" CssClass="panel">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <FormatControls:DropDownList ID="DropDownListS13" DataTextField="S1" DataValueField="iID"
                                iFlag="1" runat="server" />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="iID" EnableDefaultAppearance="False"
            ...
            <Columns>
                ...
                <dx:GridViewDataComboBoxColumn FieldName="S13" VisibleIndex="14" ShowInCustomizationForm="true">
                    <EditItemTemplate>
                        <FormatControls:DropDownList ID="DropDownList13" DataTextField="iText" DataValueField="iID"
                            iFlag="1" runat="server" Value='<%# Bind("S13") %>' />
                    </EditItemTemplate>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" TypeName="PlannedData"
