    ...
    <div class="container" style="width: 100%">
        ...
        <div class="panel  panel-primary">
            ...
            <asp:Panel runat="server" ID="divSel" Width="100%" CssClass="panel">
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="LabelS2" runat="server" CssClass="control-label">公用设备分类</asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" DataSourceID="ObjectDataSource3"
                                DataTextField="iText" DataValueField="iID" Width="100px" onselectedindexchanged="DropDownList1_SelectedIndexChanged" 
            AutoPostBack="True"  >
                            </asp:DropDownList>
                            </td>
                            <td>
                            <asp:Label ID="Label2" runat="server" CssClass="control-label">类型</asp:Label>
                        </td>
                        <td>
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="iID" EnableDefaultAppearance="False"
            ...
            <Columns>
                ...
                <EditItemTemplate>
                   <FormatControls:DropDownList ID="DropDownList1"  DataTextField="iText" DataValueField="iID"  iFlag="1" runat="server" Value='<%# Bind("S1") %>' />
                </EditItemTemplate>
            ...
            <SettingsText ConfirmDelete="是否删除?" EmptyDataRow=""  CommandEdit="是否保存"/>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" TypeName="PublicFacilitiesData" SelectMethod="Get"
        ...
        <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetEquip"
            TypeName="PublicData">
            <SelectParameters>
            </SelectParameters>
        </asp:ObjectDataSource>
        <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" SelectMethod="GetLookUpData"
            TypeName="PublicData">
            <SelectParameters>
                <asp:Parameter Name="iType" Type="String" DefaultValue="7" />
            </SelectParameters>
        </asp:ObjectDataSource>
        </form>
</body>
