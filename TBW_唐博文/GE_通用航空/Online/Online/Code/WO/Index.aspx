<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Index.aspx.cs" Inherits="WO_Index"
...
<body>
    <div class="container" style="width: 100%">
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="iID" EnableDefaultAppearance="False"
            ...
            CssClass="table" oncelleditorinitialize="ASPxGridView1_CellEditorInitialize">
            <Columns>
                ...
                <dx:GridViewDataHyperLinkColumn VisibleIndex="28" FieldName="iID" Caption= " " >
                    <PropertiesHyperLinkEdit NavigateUrlFormatString="WOSP.aspx?id={0}" Text="备件耗用">
