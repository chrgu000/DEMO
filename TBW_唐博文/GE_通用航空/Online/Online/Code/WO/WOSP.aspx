<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WOSP.aspx.cs" Inherits="WOSP_Index"
...
<body>
    <div class="container" style="width: 100%">
        ...
        <dx:ASPxGridView ID="ASPxGridView2" runat="server" KeyFieldName="iID" EnableDefaultAppearance="False"
            DataSourceID="ObjectDataSource5" AutoGenerateColumns="False" Width="100%" CssClass="table">
            <Columns>
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="iID" EnableDefaultAppearance="False"
            DataSourceID="ObjectDataSource1" AutoGenerateColumns="False" Width="100%" 
            CssClass="table" 
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" TypeName="WOSPData" SelectMethod="Get"
        ...
        <asp:ObjectDataSource ID="ObjectDataSource5" runat="server" SelectMethod="Get2"
            TypeName="WOSPData" onselecting="ObjectDataSource3_Selecting">
            <SelectParameters>
                <asp:Parameter Name="iID" Type="String" />
            </SelectParameters>
        </asp:ObjectDataSource>
        
         <asp:ObjectDataSource ID="ObjectDataSource4" runat="server" SelectMethod="GetWorker"
            TypeName="PublicData">
            <SelectParameters>
            </SelectParameters>
        </asp:ObjectDataSource>
