<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Update.aspx.cs" Inherits="WO_Update"
...
<body>
    <div class="container" style="width: 100%">
        ...
        <div class="panel  panel-primary">
            <FormatControls:Button ID="YxBtn" runat="server" OnToSelect="ToSelect" OnToBeck="ToBeck" OnToEdit="ToEdit"
                OnToDel="ToDel" OnToSave="ToSave" OnToNew="ToNew" OnToExport="ToExport" />
        </div>
        <table class="table">
        <tr>
            <td><asp:Label ID="Label11" runat="server"></asp:Label></td>
            <td style="width:30%"><asp:Label ID="LabiID" runat="server"></asp:Label></td>
            <td><asp:Label ID="Label13" runat="server"></asp:Label></td>
            <td style="width:30%"><asp:TextBox ID="TextiCode" runat="server" Enabled="false"></asp:TextBox></td>
        </tr>
        <tr>
            <td><asp:Label ID="Label1" runat="server"></asp:Label></td>
            <td style="width:30%"><FormatControls:Calendar ID="CaldDate" runat="server" ReadOnly="true" CssClass="datepickerCompleted" ></FormatControls:Calendar></td>
            <td><asp:Label ID="Label2" runat="server"></asp:Label></td>
            <td style="width:30%"><FormatControls:Select ID="SelS1" runat="server" ReadOnly="true" ></FormatControls:Select></td>
        </tr>
        <tr>
            <td><asp:Label ID="Label3" runat="server"></asp:Label></td>
            <td style="width:30%"><asp:TextBox ID="TextBox3" runat="server"></asp:TextBox></td>
            <td><asp:Label ID="Label4" runat="server"></asp:Label></td>
            <td style="width:30%"><asp:TextBox ID="TextBox4" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td><asp:Label ID="Label5" runat="server"></asp:Label></td>
            <td style="width:30%"><FormatControls:Calendar ID="Calendar1" runat="server" ReadOnly="true" CssClass="datepickerCompleted" ></FormatControls:Calendar></td>
            <td><asp:Label ID="Label6" runat="server"></asp:Label></td>
            <td style="width:30%"><FormatControls:Calendar ID="Calendar2" runat="server" ReadOnly="true" CssClass="datepickerCompleted" ></FormatControls:Calendar></td>
        </tr>
        <tr>
            <td><asp:Label ID="Label7" runat="server"></asp:Label></td>
            <td style="width:30%"><FormatControls:Calendar ID="Calendar3" runat="server" ReadOnly="true" CssClass="datepickerCompleted" ></FormatControls:Calendar></td>
            <td><asp:Label ID="Label8" runat="server"></asp:Label></td>
            <td style="width:30%"><FormatControls:Calendar ID="Calendar4" runat="server" ReadOnly="true" CssClass="datepickerCompleted" ></FormatControls:Calendar></td>
        </tr>
        <tr>
            <td><asp:Label ID="Label9" runat="server"></asp:Label></td>
            <td style="width:30%"><asp:TextBox ID="TextBox1" runat="server"></asp:TextBox></td>
            <td><asp:Label ID="Label10" runat="server"></asp:Label></td>
            <td style="width:30%"><asp:TextBox ID="TextBox2" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td><asp:Label ID="Label14" runat="server"></asp:Label></td>
            <td style="width:30%" colspan="3"><asp:TextBox ID="TextRemark" runat="server"></asp:TextBox></td>
        </tr>
        </table>
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="iID" EnableDefaultAppearance="False"
            ...
            <Columns>
                ...
                <dx:GridViewDataColumn FieldName="AutoID" VisibleIndex="1" ReadOnly="true">
                    <EditItemTemplate>
                        <asp:Label ID="labeliID" runat="server" Text='<%#  DataBinder.Eval(Container.DataItem,"AutoID") %>'></asp:Label>
                    </EditItemTemplate>
                ...
                <dx:GridViewDataColumn FieldName="Date1" VisibleIndex="17" Visible="true" Width="10%">
                    <EditItemTemplate>
                        <FormatControls:Calendar ID="CalendarD1" runat="server" ReadOnly="true" CssClass="datepickerCompleted"
                            Value='<%# Bind("Date1") %>'></FormatControls:Calendar>
                    </EditItemTemplate>
                </dx:GridViewDataColumn>
                <dx:GridViewDataColumn FieldName="Date2" VisibleIndex="17" Visible="true" Width="10%">
                    <EditItemTemplate>
                        <FormatControls:Calendar ID="CalendarD2" runat="server" ReadOnly="true" CssClass="datepickerCompleted"
                            Value='<%# Bind("Date2") %>'></FormatControls:Calendar>
                    </EditItemTemplate>
                </dx:GridViewDataColumn>
                <dx:GridViewDataColumn FieldName="Date3" VisibleIndex="17" Visible="true" Width="10%">
                    <EditItemTemplate>
                        <FormatControls:Calendar ID="CalendarD3" runat="server" ReadOnly="true" CssClass="datepickerCompleted"
                            Value='<%# Bind("Date3") %>'></FormatControls:Calendar>
                    </EditItemTemplate>
                </dx:GridViewDataColumn>
                <dx:GridViewDataColumn FieldName="Date4" VisibleIndex="17" Visible="true" Width="10%">
                    <EditItemTemplate>
                        <FormatControls:Calendar ID="CalendarD4" runat="server" ReadOnly="true" CssClass="datepickerCompleted"
                            Value='<%# Bind("Date4") %>'></FormatControls:Calendar>
                    </EditItemTemplate>
                </dx:GridViewDataColumn>
                <dx:GridViewDataColumn FieldName="Date5" VisibleIndex="17" Visible="true" Width="10%">
                    <EditItemTemplate>
                        <FormatControls:Calendar ID="CalendarD5" runat="server" ReadOnly="true" CssClass="datepickerCompleted"
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" TypeName="WOData" SelectMethod="Get"
