...
<%--                <table>
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="iID" EnableDefaultAppearance="False"
            ...
            <Columns>
                ...
                <dx:GridViewDataComboBoxColumn FieldName="S6" VisibleIndex="7" ShowInCustomizationForm="true">
                    <EditItemTemplate>
                        <FormatControls:DropDownList ID="DropDownList6" DataTextField="iText" DataValueField="iID"
                            iFlag="1" runat="server" Value='<%# Bind("S6") %>' />
                    </EditItemTemplate>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" TypeName="InventoryData"
