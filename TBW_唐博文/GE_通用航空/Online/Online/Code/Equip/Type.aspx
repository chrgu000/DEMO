<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Type.aspx.cs" Inherits="Equip_Type"
...
<body>
    <div class="container" style="width: 100%">
                ...
                <dx:GridViewDataComboBoxColumn FieldName="S3" VisibleIndex="4" ShowInCustomizationForm="true">
                    <EditItemTemplate>
                        <FormatControls:DropDownList ID="DropDownList3" DataTextField="iText" DataValueField="iID"
                            iType="7" runat="server" Value='<%# Bind("S3") %>' />
                    </EditItemTemplate>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" TypeName="EquipTypeData"
