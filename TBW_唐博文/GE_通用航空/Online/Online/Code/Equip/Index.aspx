<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Index.aspx.cs" Inherits="Equip_Index"
...
<body>
    <div class="container" style="width: 100%">
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="iID" EnableDefaultAppearance="False"
            ...
            CssClass="table" onrowdeleting="ASPxGridView1_RowDeleting" 
            ...
            <Columns>
                ...
                <dx:GridViewDataComboBoxColumn FieldName="S3" VisibleIndex="4" ShowInCustomizationForm="true">
                    <EditItemTemplate>
                        <FormatControls:DropDownList ID="DropDownList3" DataTextField="iText" DataValueField="iID"
                            iType="3" runat="server" Value='<%# Bind("S3") %>' />
                    </EditItemTemplate>
                ...
                <dx:GridViewDataTextColumn FieldName="S4" VisibleIndex="6">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataComboBoxColumn FieldName="S5" VisibleIndex="4" ShowInCustomizationForm="true">
                    <EditItemTemplate>
                        <FormatControls:DropDownList ID="DropDownList5" DataTextField="iText" DataValueField="iID"
                            iFlag="4" runat="server" Value='<%# Bind("S5") %>' />
                    </EditItemTemplate>
                    <PropertiesComboBox TextField="iText" ValueField="iID" EnableSynchronization="False"
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" TypeName="EquipData"
        ...
        <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" SelectMethod="GetEquipType"
            TypeName="PublicData">
            <SelectParameters>
            </SelectParameters>
        </asp:ObjectDataSource>
