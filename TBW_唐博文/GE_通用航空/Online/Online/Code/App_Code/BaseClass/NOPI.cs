...
public class NOPI
{
    ...
    public static bool ToExcel(DataTable dt, string SheetName)
    {
        ...
        {
            using (FileStream fs = new FileStream(SheetName, FileMode.Create, FileAccess.Write))
            {
                wk.Write(fs);
            }
        }
    ...
    public static void NewSheet(HSSFWorkbook wk,DataTable dt, string SheetName)
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            for (int j = 0; j < dt.Columns.Count; j++)
            {
                ...
                try
                {
                    //value = dt.GetRowCellDisplayText(i, dt.Columns[j]).ToString();
                }
                catch
                {
                }
                ...
                //}
                //else if (dt.Columns[j].DataType == DevExpress.Utils.FormatType.Numeric)
                //{
                //    if (value != "")
                //    {
                //        double svalue = double.Parse(value);
                ...
                //}
                //else if (dt.Columns[j].DisplayFormat.FormatType == DevExpress.Utils.FormatType.DateTime)
                //{
                //    if (value != "")
                //    {
