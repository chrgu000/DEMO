...
namespace PMMWS
{
    public partial class MaintenanceWebInfoB : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //SMOrder
                SMOrder mao = SMOrder.Find(Convert.ToInt32(orderId));
        ...
        private void LoadMachiInfo(string oderInfo, SMOrder mao)
        {
            ...
            //try
            //{
            //    Worker wo = Worker.Find(mao.WorkId);
        ...
        protected void saveButton_Click(object sender, EventArgs e)
        {
            ...
            mao.PartNO = this.partNum0.Text + "+" + this.partNum1.Text + "+" + this.partNum2.Text;
