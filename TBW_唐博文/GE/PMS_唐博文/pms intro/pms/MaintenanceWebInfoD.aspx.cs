...
namespace PMMWS
{
    public partial class MaintenanceWebInfoD : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //SMOrder
                HPOrder  mao = HPOrder.Find(Convert.ToInt32(orderId));
        ...
        private void LoadMachiInfo(string oderInfo, HPOrder mao)
        {
