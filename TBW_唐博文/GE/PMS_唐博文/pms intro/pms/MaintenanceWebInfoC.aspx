<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaintenanceWebInfoC.aspx.cs" Inherits="PMMWS.MaintenanceWebInfoC" %>
    ...
    <div>
        <table align="center" bgcolor="#CCFFFF" width="1024" border="1">
         ...
         <asp:Button ID="cancelButton" runat="server" CssClass="dxcaTextBoxCell" 
            ...
            <tr>
            <td align="center" class="style11" rowspan="6">
