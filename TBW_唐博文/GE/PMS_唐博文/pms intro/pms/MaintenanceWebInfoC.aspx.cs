...
namespace PMMWS
{
    public partial class MaintenanceWebInfoC : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                CMOrder mao = CMOrder.Find(Convert.ToInt32(orderId));
        ...
        private void LoadMachiInfo(string oderInfo, CMOrder mao)
        {
