<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Update.aspx.cs" Inherits="SP_Update"
...
<label  id="l1" runat="server" ></label>
    <script language="javascript" type="text/javascript">
        ...
        function doSave() {
            ...
            var obj = Ajax.SPAjaxMethod.Insert(iid, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, date1, date2, date3, date4, date5, d1, d2, d3, d4, d5, d6, d7, d8, d9, d10);
        ...
        function doDel() {
            var idleft = "_ctl0_CenterContent_";
            var iid = document.getElementById(idleft + "YxBtn_hidID").value;
            var obj = Ajax.SPAjaxMethod.Delete(iid);
            if (obj != null && obj.value==true) {
                window.location.href = "Index.aspx";
                return false;
            }
