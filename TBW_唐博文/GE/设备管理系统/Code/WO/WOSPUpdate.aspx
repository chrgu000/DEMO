<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WOSPUpdate.aspx.cs" Inherits="WO_WOSPUpdate"
...
<asp:Content ID="Content1" ContentPlaceHolderID="CenterContent" runat="server">
    <div class="container" style="width: 100%;" id="div1" runat="server">
        <div class="panel  panel-primary">
            ...
            <table style="width:1000px;margin-left:auto;margin-right:auto" id="Table1"  runat="server">
...
<label  id="l1" runat="server" ></label>
    <script language="javascript" type="text/javascript">
        ...
        function doSave() {
            ...
            var lhiditype = document.getElementById(idleft + "hidiType");
            var i1 = "";
            i1 = lhiditype.value;
            if (i1 == "") {
                alert("未找到相应工单");
            ...
            var obj = Ajax.WOSPAjaxMethod.Insert(iid, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, date1, date2, date3, date4, date5, d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, i1);
            if(obj!=null && obj.value==true) {
                window.location.href = "WOSPIndex.aspx?iType="+i1;
                return false;
            }
        ...
        function doDel() {
            ...
            //            if (Ajax.WOAjaxMethod.IsDelete(s1.value) == false) {
            var obj = Ajax.WOSPAjaxMethod.Delete(iid, i1);
                if (obj != null && obj.value == true) {
                    window.location.href = "WOSPIndex.aspx?iType=" + i1;
                    return false;
                }
