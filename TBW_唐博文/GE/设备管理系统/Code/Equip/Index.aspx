        ...
        <div class="panel  panel-primary">
            ...
            <asp:Panel runat="server" ID="divSel" Width="100%" CssClass="panel">
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="LabelS2" runat="server" CssClass="control-label">区域</asp:Label>
                        </td>
                        <td>
                            <FormatControls:DropDownList ID="DropDownListS3" DataTextField="iText" DataValueField="iID"
