...
namespace Ajax
{
    ...
    /// </summary>
    public class WOSPAjaxMethod : System.Web.UI.Page
    {
        ...
        public bool Insert(string iID, string S1, string S2, string S3, string S4, string S5, string S6, string S7, string S8, string S9, string S10, string S11, string S12, string S13, string S14, string S15,
         ...
         string D1, string D2, string D3, string D4, string D5, string D6, string D7, string D8, string D9, string D10,string I1)
        {
            ...
            if (I1 != "")
            {
                sql.ToString("I1", int.Parse(I1));
            }
            else
            {
                sql.ToString("I1", null);
            }
        ...
        [AjaxPro.AjaxMethod(AjaxPro.HttpSessionStateRequirement.Read)]
        public bool Delete(string iID,string I1)
        {
            sSQL = "delete from " + tablename + " where iID='" + iID + "' and I1='" + I1 + "'";
