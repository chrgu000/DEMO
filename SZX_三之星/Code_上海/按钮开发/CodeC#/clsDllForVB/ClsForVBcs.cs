...
namespace clsDllForVB
{
    ...
    public interface iClassForVB
    {
        ...
        string TH006(string s1, string s2, string s3, string s4, string s5, string s6);
    }
    ...
    public class ClsTH001 : iClassForVB
    {
        ...
        public string TH006(string s1, string s2, string s3, string s4, string s5, string s6)
        {
            Frm销售订单导出 frm = new Frm销售订单导出(s1, s2, s3, s4, s5, s6);
