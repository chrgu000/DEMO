...
Left(a.cRdCode,5) As cRdCode, 
 ...
 SELECT cast(1 as bit) as 选择
        ...
        ,cast(isnull(c.iQty,0) as decimal(16,0)) as 实绩在库,cast(isnull(c.iQty,0) - isnull(c.ipeqty,0) as decimal(16,0)) as 有效在库
		,cast(SUM(isnull(iQCJCSL,0)) as decimal(16,0)) AS  前残
		,cast(SUM(iOutQuantity) as decimal(16,0)) as 月出库数量
		,cast(SUM(iInQuantity) as decimal(16,0)) as 月入库数量
        ,0 as 月调整数量
        ,cast(isnull(c.ipeqty,0) as decimal(16,0)) as 引当后在库数量
        ,getdate() as 在库年月
...
GROUP BY a.cWhCode ,  A.cInvCode , b.cInvDefine2,b.cComUnitCode,c.iQty,b.cInvDefine13 ,b.cInvDefine10,b.cInvDefine7,d.cEnSingular,g.iUnitPrice,e.iqty,c.ipeqty,b.cinvccode,f.cidefine12
