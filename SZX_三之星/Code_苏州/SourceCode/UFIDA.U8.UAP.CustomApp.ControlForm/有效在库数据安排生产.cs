...
select cast(1 as bit) as 选择
    ,a.cWhCode as 仓库编号,a.cInvCode as 产品编号,b.cInvName as 产品编号备注,null as 符号,cast(sum(a.iQuantity) as decimal(16,3)) as 有效在库数量
    ,b.cInvDefine1 as 生产线							
from CurrentStock a inner join Inventory b on a.cInvCode = b.cInvCode
    
where 1=1 and isnull(bSelf ,0) = 1 and b.cInvCCode like '02%'
group by a.cWhCode,a.cInvCode,b.cInvName,b.cInvDefine1
having sum(cast((a.iQuantity - isnull(a.fOutQuantity,0)) as decimal(16,3)))>0
order by a.cInvCode
";
