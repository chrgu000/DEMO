namespace ImportDLL
{
    partial class Frm执行存储过程
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.gridCol存储过程名称 = new DevExpress.XtraGrid.Columns.GridColumn();
            this.gridCol数据库 = new DevExpress.XtraGrid.Columns.GridColumn();
            this.gridCol参数1 = new DevExpress.XtraGrid.Columns.GridColumn();
            this.gridCol参数2 = new DevExpress.XtraGrid.Columns.GridColumn();
            this.gridCol参数3 = new DevExpress.XtraGrid.Columns.GridColumn();
            ...
            this.gridCol选择.Width = 41;
            // 
            // gridCol存储过程名称
            // 
            this.gridCol存储过程名称.Caption = "存储过程名称";
            this.gridCol存储过程名称.FieldName = "存储过程名称";
            this.gridCol存储过程名称.Name = "gridCol存储过程名称";
            this.gridCol存储过程名称.Visible = true;
            this.gridCol存储过程名称.VisibleIndex = 1;
            this.gridCol存储过程名称.Width = 131;
            // 
            // gridCol数据库
            // 
            this.gridCol数据库.Caption = "数据库";
            this.gridCol数据库.FieldName = "数据库";
            this.gridCol数据库.Name = "gridCol数据库";
            this.gridCol数据库.Visible = true;
            this.gridCol数据库.VisibleIndex = 2;
            this.gridCol数据库.Width = 134;
            // 
            // gridCol参数1
            // 
            this.gridCol参数1.Caption = "参数1";
            this.gridCol参数1.FieldName = "参数1";
            this.gridCol参数1.Name = "gridCol参数1";
            this.gridCol参数1.Visible = true;
            this.gridCol参数1.VisibleIndex = 3;
            this.gridCol参数1.Width = 130;
            // 
            // gridCol参数2
            // 
            this.gridCol参数2.Caption = "参数2";
            this.gridCol参数2.FieldName = "参数2";
            this.gridCol参数2.Name = "gridCol参数2";
            this.gridCol参数2.Visible = true;
            this.gridCol参数2.VisibleIndex = 4;
            this.gridCol参数2.Width = 123;
            // 
            // gridCol参数3
            // 
            this.gridCol参数3.Caption = "参数3";
            this.gridCol参数3.FieldName = "参数3";
            this.gridCol参数3.Name = "gridCol参数3";
            this.gridCol参数3.Visible = true;
            this.gridCol参数3.VisibleIndex = 5;
            this.gridCol参数3.Width = 146;
            // 
            ...
            this.Name = "Frm执行存储过程";
            this.Text = "执行存储过程";
            this.Load += new System.EventHandler(this.Frm执行存储过程_Load);
        ...
        private DevExpress.XtraGrid.Columns.GridColumn gridCol存储过程名称;
        private DevExpress.XtraGrid.Columns.GridColumn gridCol数据库;
        private DevExpress.XtraGrid.Columns.GridColumn gridCol参数1;
        private DevExpress.XtraGrid.Columns.GridColumn gridCol参数2;
        private DevExpress.XtraGrid.Columns.GridColumn gridCol参数3;
    }
}