namespace ImportDLL
{
    partial class Frm会计科目部门对照表
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.gridCol部门编码.ColumnEdit = this.ItemLookUpEdit部门编码;
            this.gridCol部门编码.FieldName = "部门";
            this.gridCol部门编码.Name = "gridCol部门编码";
            this.gridCol部门编码.Visible = true;
            this.gridCol部门编码.VisibleIndex = 2;
            // 
            // ItemLookUpEdit部门编码
            // 
            ...
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("iID", "部门编码"),
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("iText", "部门名称")});
            this.ItemLookUpEdit部门编码.DisplayMember = "iID";
            this.ItemLookUpEdit部门编码.Name = "ItemLookUpEdit部门编码";
            this.ItemLookUpEdit部门编码.ValueMember = "iID";
            // 
            // gridCol部门名称
            // 
            this.gridCol部门名称.Caption = "部门名称";
            this.gridCol部门名称.ColumnEdit = this.ItemLookUpEdit部门名称;
            this.gridCol部门名称.FieldName = "部门";
            this.gridCol部门名称.Name = "gridCol部门名称";
            this.gridCol部门名称.Visible = true;
            this.gridCol部门名称.VisibleIndex = 3;
            this.gridCol部门名称.Width = 223;
            // 
            // ItemLookUpEdit部门名称
            // 
            ...
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("iText", "部门名称"),
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("iID", "部门编码")});
            this.ItemLookUpEdit部门名称.DisplayMember = "iText";
            this.ItemLookUpEdit部门名称.Name = "ItemLookUpEdit部门名称";
            this.ItemLookUpEdit部门名称.ValueMember = "iID";
            // 
            // layoutControlGroup1
            // 
