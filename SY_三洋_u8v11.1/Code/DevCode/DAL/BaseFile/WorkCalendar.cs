    ...
    public partial class WorkCalendar
    {
        ...
        public int Save(List<TH.Model.WorkCalendar> l)
        {
            ...
            try
            {
                ...
                {
                    string sSQL = "select * from dbo.WorkCalendar where [LineNo] = '" + l[i].LineNo + "' and iYear = " + l[i].iYear + " and iMonth = " + l[i].iMonth + "";
        ...
        public string Add(TH.Model.WorkCalendar model)
        {
            ...
            if (model.i27 != null && model.i27 != 0)
            {
                strSql1.Append("i27,");
                strSql2.Append("" + model.i27 + ",");
            }
            if (model.i28 != null && model.i28 != 0)
            {
                strSql1.Append("i28,");
                strSql2.Append("" + model.i28 + ",");
            }
            if (model.i29 != null && model.i29 != 0)
            {
                strSql1.Append("i29,");
        ...
        public string Update(TH.Model.WorkCalendar model)
        {
            ...
            strSql.Remove(n, 1);
            strSql.Append(" where [LineNo]=" + model.LineNo + " and iYear = " + model.iYear + " and iMonth = " + model.iMonth);
            return strSql.ToString();
        ...
        public TH.Model.WorkCalendar GetModel(int iID)
        {
            ...
            strSql.Append(" iID,GUID,CreateUid,CreateDate,UpdateUid,UpdateDate,[LineNo],iYear,iMonth,i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15,i16,i17,i18,i19,i20,i21,i22,i23,i24,i25,i26,i27,i28,i29,i30,i31 ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select iID,GUID,CreateUid,CreateDate,UpdateUid,UpdateDate,[LineNo],iYear,iMonth,i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15,i16,i17,i18,i19,i20,i21,i22,i23,i24,i25,i26,i27,i28,i29,i30,i31 ");
            strSql.Append(" FROM WorkCalendar ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
            strSql.Append(" order by iYear,iMonth ");
