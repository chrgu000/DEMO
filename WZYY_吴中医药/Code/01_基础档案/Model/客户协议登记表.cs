...
{
    /// <summary>
    /// 客户协议登记表:实体类(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class 客户协议登记表
    {
        ...
        private string _返点方式;
        private string _或有条款;
        private int _是否有纸质合同;
        private string _品种;
        private decimal? _底价;
        private decimal? _协议销量;
        private decimal? _保证金;
        private decimal? _m1;
        private decimal? _m2;
        private decimal? _m3;
        private decimal? _m4;
