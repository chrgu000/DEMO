...
namespace 系统服务
{
    public class ClsGetSQL
    {
        ...
        {
            return GetDeleteSQL(系统服务.ClsBaseDataInfo.sDataBaseName, sTableName, dtTemp, iRow);
        }
        ...
        {
            return GetUpdateSQL(系统服务.ClsBaseDataInfo.sDataBaseName, sTableName, dtTemp, iRow);
        }
        ...
        {
            return GetInsertSQL(系统服务.ClsBaseDataInfo.sDataBaseName, sTableName, dtTemp, iRow);
        }
