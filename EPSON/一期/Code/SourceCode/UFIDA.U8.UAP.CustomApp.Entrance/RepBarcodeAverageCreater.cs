...
{
    public class RepBarcodeAverageCreater : INetUserControl
    {
        ...
        System.Windows.Forms.Control INetUserControl.CreateControl(UFSoft.U8.Framework.Login.UI.clsLogin login, string MenuID, string Paramters)
        {
            ...
            if (clsUser.chkRight(login, "TH_22"))
            {
                RepBarcodeAverage fm = new RepBarcodeAverage();
                fm.Conn = conn;
                ...
                this._Title = "Production TAT (Average)";
