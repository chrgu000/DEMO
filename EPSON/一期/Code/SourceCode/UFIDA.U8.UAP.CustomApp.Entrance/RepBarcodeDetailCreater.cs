...
{
    public class RepBarcodeDetailCreater : INetUserControl
    {
        ...
        System.Windows.Forms.Control INetUserControl.CreateControl(UFSoft.U8.Framework.Login.UI.clsLogin login, string MenuID, string Paramters)
        {
            ...
            if (clsUser.chkRight(login, "TH_23"))
            {
                RepBarcodeDetail fm = new RepBarcodeDetail();
                fm.Conn = conn;
                ...
                this._Title = "Production TAT(Details)";
