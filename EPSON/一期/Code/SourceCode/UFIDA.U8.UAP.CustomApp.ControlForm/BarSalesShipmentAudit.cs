...
";
                    ...
                    sSQL = @"
if exists(select * from VoucherHistory where cSeed = 'DPaaaaaa' AND cContentRule like '%YYYY%' AND CardNumber = '01')
	update VoucherHistory set cNumber = bbbbbb  where cSeed = 'DPaaaaaa' AND cContentRule like '%YYYY%' AND CardNumber = '01'
else
