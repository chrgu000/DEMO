...
namespace UFIDA.U8.UAP.CustomApp.ControlForm.DAL
{
    ...
    public partial class DispatchLists
    {
        ...
        /// 是否存在该记录
        /// </summary>
        public string Exists(int AutoID, int DLID, int iDLsID)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from DispatchLists");
            strSql.Append(" where AutoID=" + AutoID + " and DLID=" + DLID + " and iDLsID=" + iDLsID + " ");
        ...
        /// 增加一条数据
        /// </summary>
        public string Add(UFIDA.U8.UAP.CustomApp.ControlForm.Model.DispatchLists model)
        {
            StringBuilder strSql = new StringBuilder();
