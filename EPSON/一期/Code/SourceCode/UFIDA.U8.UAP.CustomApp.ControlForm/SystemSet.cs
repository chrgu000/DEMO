...
namespace UFIDA.U8.UAP.CustomApp.ControlForm
{
    public partial class SystemSet : UserControl
    {
        ...
        { 
            string sSQL = @"
select a.cSTCode,a.cSTName, b.cWhCode, b.cRdCode, b.SAPCode, b.SAPWorkCenter, b.InternalOrder, b.Remark, b.CreaterUid, b.CreaterDate
	,CAST(null as varchar(50)) as iState
from SaleType a left join dbo._SystemSet b on a.cSTCode = b.cSTCode
order by a.cSTCode
";
        ...
        private void SetLookUp()
        {
            ...
            sSQL = "select cRdCode,cRdName from Rd_Style where isnull(bRdEnd,0) = 1 and bRdFlag = 1 order by cRdCode ";
            dt = DbHelperSQL.Query(sSQL);
            dr = dt.NewRow();
            dt.Rows.InsertAt(dr, 0);
            ItemLookUpEditcRdCode.DataSource = dt;
            ItemLookUpEditcRdName.DataSource = dt;
        }
    }
}
