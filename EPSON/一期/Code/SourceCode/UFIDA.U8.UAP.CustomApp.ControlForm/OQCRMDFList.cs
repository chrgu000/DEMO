...
{
    public partial class OQCRMDFList : UserControl
    {
        ...
        private void btnRefresh_Click(object sender, EventArgs e)
        {
            ...
            {
                string sSQL = @"
SELECT a.*,cus.cCusName,case when a.OQCStatus = 'OQC-Passed' then 'Passed' else 'Failed' end as OQCResult
FROM _OQC_RMDF a 
...
";
                ...
                {
                    sSQL = sSQL.Replace("1=1", "1=1 and OQCNo = '" + txtRMDFNo.Text.Trim() + "'");
                }
        ...
        private void OQCRMDFList_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void gridView1_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                string sCode = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, gridColOQCNo).ToString().Trim();
                if (sCode != "")
                {
                    FrmOQCRMDF frm = new FrmOQCRMDF(u8_login, sCode, Conn,sLogDate);
                    frm.ShowDialog();
                }
            }
            catch (Exception ee)
...
";
        ...
        private void txtRMDFNo_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
