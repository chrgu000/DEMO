...
namespace UFIDA.U8.UAP.CustomApp.ControlForm.DAL
{
    ...
    public partial class DispatchList
    {
        ...
        /// 是否存在该记录
        /// </summary>
        public string Exists(int DLID, string cexch_name, string cVouchType, string cSTCode, DateTime dDate, string cDepCode)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from DispatchList");
            strSql.Append(" where DLID=" + DLID + " and cexch_name='" + cexch_name + "' and cVouchType='" + cVouchType + "' and cSTCode='" + cSTCode + "' and dDate='" + dDate + "' and cDepCode='" + cDepCode + "' ");
