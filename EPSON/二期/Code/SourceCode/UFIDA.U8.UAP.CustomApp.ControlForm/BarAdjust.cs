...
";
        ...
        private void gridView1_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            try
            {
                ...
                decimal dQtySale = BaseFunction.ReturnDecimal(gridView1.GetRowCellValue(iRow, gridColcbdefine4));
                ...
                if (dLotQTY > dQtySale)
                {
                    MessageBox.Show("LotQTY is err");
                    gridView1.SetRowCellValue(iRow, gridColLOTQTY, DBNull.Value);
                    gridView1.FocusedRowHandle = iRow;
                    gridView1.FocusedColumn = gridColOtherQTY;
                }
            }
