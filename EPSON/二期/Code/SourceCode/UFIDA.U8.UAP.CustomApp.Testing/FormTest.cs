...
namespace WindowsFormsApplication1
{
    public partial class FormTest : Form
    {
        ...
        {
            FrmCustomerFeedback frm = new FrmCustomerFeedback();
            frm.Show();
        }

        private void btnIQCResult_Click(object sender, EventArgs e)
        {
            FrmIQCResult frm = new FrmIQCResult();
            frm.Show();
        }

        private void btnDefects_Click(object sender, EventArgs e)
        {
            FrmDefect frm = new FrmDefect();
            frm.Show();
        }
        ...
        private void btnActionFCost_Click(object sender, EventArgs e)
        {
            FrmActionFCost frm = new FrmActionFCost();
            frm.Show();
        }
    }
}
