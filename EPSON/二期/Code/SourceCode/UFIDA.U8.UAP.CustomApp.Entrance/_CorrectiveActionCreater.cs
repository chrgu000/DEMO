...
{
    public class _CorrectiveActionCreater : INetUserControl
    {
        ...
        System.Windows.Forms.Control INetUserControl.CreateControl(UFSoft.U8.Framework.Login.UI.clsLogin login, string MenuID, string Paramters)
        {
            ...
            if (clsUser.chkRight(login, "TH_2_18"))
            {
                _CorrectiveAction fm = new _CorrectiveAction();
                fm.Conn = conn;
                ...
                this._Title = "Corrective Action Report Logsheet";
