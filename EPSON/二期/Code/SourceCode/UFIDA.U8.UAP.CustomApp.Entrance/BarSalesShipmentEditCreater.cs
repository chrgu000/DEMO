...
{
    public class BarSalesShipmentEditCreater : INetUserControl
    {
        ...
        System.Windows.Forms.Control INetUserControl.CreateControl(UFSoft.U8.Framework.Login.UI.clsLogin login, string MenuID, string Paramters)
        {
            ...
            if (clsUser.chkRight(login, "TH_27"))
            {
                BarSalesShipmentEdit fm = new BarSalesShipmentEdit();
                fm.Conn = conn;
                ...
                this._Title = "Pending Sales Shipment List";
