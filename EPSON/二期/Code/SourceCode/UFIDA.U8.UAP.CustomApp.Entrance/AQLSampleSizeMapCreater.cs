...
{
    public class AQLSampleSizeMapCreater : INetUserControl
    {
        ...
        System.Windows.Forms.Control INetUserControl.CreateControl(UFSoft.U8.Framework.Login.UI.clsLogin login, string MenuID, string Paramters)
        {
            ...
            if (clsUser.chkRight(login, "TH_2_14"))
            {
                _AQLSampleSizeMap fm = new _AQLSampleSizeMap();
                fm.Conn = conn;
                ...
                this._Title = "AQL SampleSize Map";
