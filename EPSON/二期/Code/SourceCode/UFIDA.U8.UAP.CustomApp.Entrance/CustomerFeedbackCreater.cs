...
{
    public class CustomerFeedbackCreater : INetUserControl
    {
        ...
        System.Windows.Forms.Control INetUserControl.CreateControl(UFSoft.U8.Framework.Login.UI.clsLogin login, string MenuID, string Paramters)
        {
            ...
            if (clsUser.chkRight(login, "TH_2_08"))
            {
                CustomerFeedback fm = new CustomerFeedback();
                fm.Conn = conn;
