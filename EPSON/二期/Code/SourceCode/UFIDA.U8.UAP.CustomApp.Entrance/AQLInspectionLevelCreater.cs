...
{
    public class AQLInspectionLevelCreater : INetUserControl
    {
        ...
        System.Windows.Forms.Control INetUserControl.CreateControl(UFSoft.U8.Framework.Login.UI.clsLogin login, string MenuID, string Paramters)
        {
            ...
            if (clsUser.chkRight(login, "TH_2_03"))
            {
                _AQLInspectionLevel fm = new _AQLInspectionLevel();
                fm.Conn = conn;
                ...
                this._Title = "AQL Inspection Level";
