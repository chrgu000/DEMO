...
namespace clsU8
{
    public partial class Frm产成品入库单检验 : Form
    {
        ...
        string s存货编码 = "";
        private void Frm产成品入库单检验_Load(object sender, EventArgs e)
        {
...
order by b.AUTOID";
        ...
        public Frm产成品入库单检验(string s1, string s2, string s3, string s4, string s5)
        {
            InitializeComponent();
