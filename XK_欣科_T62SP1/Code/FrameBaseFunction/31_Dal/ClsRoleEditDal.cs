...
namespace FrameBaseFunction.Dal
{
    class ClsRoleEditDal
    {
        ...
        /// 增加一条数据
        /// </summary>
        private string AddRole(FrameBaseFunction.Model.ClsRoleInfoMod model)
        {
            int iClose = 0;
        ...
        /// 更新一条数据
        /// </summary>
        private string UpdateRole(FrameBaseFunction.Model.ClsRoleInfoMod model)
        {
            int iClose;
            StringBuilder strSql = new StringBuilder();
        ...
        public void UpdateSQL(FrameBaseFunction.Model.ClsRoleInfoMod model, DataTable dt)
        {
        ...
        public void AddSQL(FrameBaseFunction.Model.ClsRoleInfoMod model, DataTable dt)
        {
            ArrayList arrList = new ArrayList();
