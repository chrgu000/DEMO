<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateFormMenu_List.aspx.cs" Inherits="System_CreateFormMenu_List" MasterPageFile="~/System/CreateFormMenu.master"  %>
...
var i = 0;
function doSave() {
    var idleft = "_ctl0__ctl0_CenterContent_CenterRightContent_";
...
function getChange(i) {
    var idleft = "_ctl0__ctl0_CenterContent_CenterRightContent_";
    var dt = document.getElementById(idleft + "SmartGridView1");
