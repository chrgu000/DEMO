...
namespace UFIDA.U8.UAP.CustomApp.ControlForm.DAL
{
    ...
    public partial class GL_accvouch
    {
        ...
        /// 是否存在该记录
        /// </summary>
        public string Exists(int i_id, int ibook, string ccode, int iperiod, int inid)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from GL_accvouch");
            strSql.Append(" where i_id=" + i_id + " and ibook=" + ibook + " and ccode='" + ccode + "' and iperiod=" + iperiod + " and inid=" + inid + " ");
