    ...
    public partial class GL_Code : UserControl
    {
        ...
        private void Frm_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string sSQL = "select ccode,ccode_name from code where ISNULL(bend ,0) = 1 and iyear = aaaaaa order by ccode";
                sSQL = sSQL.Replace("aaaaaa", BaseFunction.ReturnDate(sLogDate).Year.ToString());
            ...
            try
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < gridView1.RowCount; i++)
                    {
                        ...
                        if (model.对照科目 != "")
                        {
                            sSQL = dal.Exists( model.对照科目, model.iID.ToString());
