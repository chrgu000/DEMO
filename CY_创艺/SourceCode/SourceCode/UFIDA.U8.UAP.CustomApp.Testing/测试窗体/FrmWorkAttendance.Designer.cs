...
{
    partial class FrmWorkAttendance
    {
        /// <summary>
        ...
        {
            this.rdIn1 = new UFIDA.U8.UAP.CustomApp.ControlForm.WorkAttendance();
            this.SuspendLayout();
            // 
            // rdIn1
            // 
        ...
        private UFIDA.U8.UAP.CustomApp.ControlForm.WorkAttendance rdIn1;
    }
}