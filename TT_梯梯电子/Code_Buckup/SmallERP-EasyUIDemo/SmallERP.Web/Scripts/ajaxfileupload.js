jQuery.extend({
    createUploadIframe: function (id, uri) {
        ...
        if (window.ActiveXObject) {
            ...
            //    io.id = frameId;
            //    io.name = frameId;
            //} else if (jQuery.browser.msie && (jQuery.browser.version == "6.0") || jQuery.browser.msie && (jQuery.browser.version == "7.0") || jQuery.browser.msie && (jQuery.browser.version == "8.0")) {
    ...
    ajaxFileUpload: function (s) {
        ...
        //var form = jQuery.createUploadForm(id, s.fileElementId, s.data, s.fileElement);
