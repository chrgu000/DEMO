...
{
    public class TK_ListBusiness
    {
        private readonly TK_ListData dal = new TK_ListData();
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public List<TK_ListEntity> DataTableToList(DataTable dt)
        {
            List<TK_ListEntity> modelList = new List<TK_ListEntity>();
        ...
        public string Update(TK_ListEntity model)
        {
            //bool result = false;
            string result = "";
            TK_ListData dal = new TK_ListData();
            // 插入数据库
