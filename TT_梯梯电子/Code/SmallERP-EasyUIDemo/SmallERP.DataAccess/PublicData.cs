...
namespace SmallERP.DataAccess
{
    public class PublicData
    {
        ...
        public DataTable GetPlannerList()
        {
            ...
            strSql.AppendFormat(" Select distinct default_plannerid as iID,default_plannerid as iText From _GET_TK_PGROUP_CATECORY order by default_plannerid");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.AppendFormat(" Select distinct category as iID,category as iText From _GET_TK_PGROUP_CATECORY order by category");
            DataSet ds = DbHelperSQL.Query(strSql.ToString());
            return ds.Tables[0];
        }
