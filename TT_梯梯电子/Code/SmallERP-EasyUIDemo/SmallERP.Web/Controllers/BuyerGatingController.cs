...
namespace SmallERP.Web.Controllers
{
    public class BuyerGatingController : Controller
    {
        ...
        public ActionResult GetList()
        {
            ...
            DataTable result = Bll.GetList(sWhere, param, out total, true);
        ...
        public ActionResult DownloadExcel()
        {
            ...
            BuyerGatingBusiness Bll = new BuyerGatingBusiness();
            DataTable result = Bll.GetList(sWhere, param, out total,false);

            //TK_PeriodBusiness Bllp = new TK_PeriodBusiness();
            //DataTable dtp = Bllp.GetList(queryVersion);

            NPOIHelper npoi = new NPOIHelper();
            npoi.ExportByWebBuyGating(result, "Sheet1", "BuyGating-" + queryVersion + ".xlsx");
