...
namespace SmallERP.Web.Controllers
{
    public class CycleController : BaseController
    {
        ...
        public ActionResult GetList()
        {
            ...
            TK_Base_ItemNo_CycleBusiness Bll = new TK_Base_ItemNo_CycleBusiness();
        ...
        public ActionResult Update()
        {
            try
            {
                ...
                TK_Base_ItemNo_CycleBusiness roleBll = new TK_Base_ItemNo_CycleBusiness();
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    if (dt.Rows[i]["iCycle"] != null && dt.Rows[i]["iCycle"].ToString() != "") model.iCycle = Int32.Parse(dt.Rows[i]["iCycle"].ToString());
                    if (dt.Rows[i]["Remark"] != null && dt.Rows[i]["Remark"].ToString() != "") model.Remark = dt.Rows[i]["Remark"].ToString();
