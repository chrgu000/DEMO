...
namespace SmallERP.Web.Controllers
{
    public class PADController : Controller
    {
        ...
        public ActionResult GetList()
        {
            ...
            //PADBusiness Bll = new PADBusiness();
            //List<PADEntity> list = Bll.GetList();
            //if (!string.IsNullOrEmpty(filterName))
            //    list = list.Where(p => p.sVersion.Contains(filterName)).ToList();
            //return Json(list);

            object list = new object[] { 
                new { PartNo = "085-898401", Desc = "Desc", Childsm=""
                    , ST0001="", ST0002="", ST0003="", ST0004="", ST0005="",
                    W1="", W2="", W3="",
                    June="", ETA="", Status="", Month=""},
                new { PartNo = "085-898402", Desc = "Desc", Childsm=""
                    , ST0001="", ST0002="", ST0003="", ST0004="", ST0005="",
                    W1="", W2="", W3="",
                    June="", ETA="", Status="", Month=""},
                new { PartNo = "085-898403", Desc = "Desc", Childsm=""
                    , ST0001="", ST0002="", ST0003="", ST0004="", ST0005="",
                    W1="", W2="", W3="",
                    June="", ETA="", Status="", Month=""},
            };
            SuccessJsonResult obj = new SuccessJsonResult(list, 3);
