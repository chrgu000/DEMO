...
{
    public class TK_Base_ItemNo_ExcludeBusiness
    {
        private readonly TK_Base_ItemNo_ExcludeData dal = new TK_Base_ItemNo_ExcludeData();
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public List<TK_Base_ItemNo_ExcludeEntity> DataTableToList(DataTable dt)
        {
            List<TK_Base_ItemNo_ExcludeEntity> modelList = new List<TK_Base_ItemNo_ExcludeEntity>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                TK_Base_ItemNo_ExcludeEntity model;
        ...
        {
            List<TK_Base_ItemNo_ExcludeEntity> result;
        ...
        ///// <returns></returns>
        //public List<TK_Base_ItemNo_ExcludeEntity> GetList(string sWhere, SearchAdminDomain domain, out int total)
        //{
        //    List<TK_Base_ItemNo_ExcludeEntity> result;
        ...
        public string Update(TK_Base_ItemNo_ExcludeEntity model)
        {
            //bool result = false;
            string result = "";
            TK_Base_ItemNo_ExcludeData dal = new TK_Base_ItemNo_ExcludeData();
            // 插入数据库
