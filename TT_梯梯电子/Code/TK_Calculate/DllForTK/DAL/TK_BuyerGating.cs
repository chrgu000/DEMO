...
{
    public class TK_BuyerGating
    {

        public TK_BuyerGating()
        { }
        ...
        /// <returns></returns>
		public string Add(Model.TK_BuyerGating model)
        {
        ...
        /// <returns></returns>
        public Model.TK_BuyerGating DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                {
                    model.Period01 = BaseFunction.ReturnDecimal(row["Period01"]);
                }
                if (row["Period02"] != null)
                {
                    model.Period02 = BaseFunction.ReturnDecimal(row["Period02"]);
                }
                if (row["Period03"] != null)
                {
                    model.Period03 = BaseFunction.ReturnDecimal(row["Period03"]);
                }
                if (row["Period04"] != null)
                {
                    model.Period04 = BaseFunction.ReturnDecimal(row["Period04"]);
                }
                if (row["Period05"] != null)
                {
                    model.Period05 = BaseFunction.ReturnDecimal(row["Period05"]);
                }
                if (row["Period06"] != null)
                {
                    model.Period06 = BaseFunction.ReturnDecimal(row["Period06"]);
                }
                if (row["Period07"] != null)
                {
                    model.Period07 = BaseFunction.ReturnDecimal(row["Period07"]);
                }
