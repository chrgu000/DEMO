...
namespace FrameBaseFunction.Query
{
    class ClsRoleEditQuery
    {
        ...
        public DataTable GetAllDt()
        {
            ...
            try
            {
                string sSQL = "SELECT vchrUid, vchrName,vchrRemark, dtmCreate, dtmClose, ' ' AS bChoosed " +
                                "FROM _UserInfo " +
        ...
        public DataTable GetUserRole(string sRoleID)
        {
            ...
            try
            {
                string sSQL = "select _UserInfo.vchrUid,vchrName,vchrRemark,dtmCreate,dtmClose, " +
