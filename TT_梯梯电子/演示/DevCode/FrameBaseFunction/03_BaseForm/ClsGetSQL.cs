...
namespace FrameBaseFunction
{
    public class ClsGetSQL
    {
        ...
        public string GetUpdateSQL(string sDataBaseName, string sTableName, DataTable dtTemp, int iRow)
        {
            ...
            string sDateTime = "select getdate()";
            sDateTime = clsSQL.ExecGetScalar(sDateTime).ToString().Trim();

            s = s.Replace("1900-1-31 0:00:00", sDateTime);
            s = s.Replace("1900-01-31 0:00:00", sDateTime);
            return s;
        }
