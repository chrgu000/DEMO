            ...
            for (int i = 0; i < dr2.Length; i++)
            {
                if (dr2[i]["bUsed"].ToString().Trim() == "-1")
                {
                    ...
                    sSQL = "Insert Into @u8.PU_ArrivalVouch(ivtid,id,ccode,cptcode,ddate,cvencode,cdepcode,cpersoncode,cpaycode,csccode,cexch_name,iexchrate,itaxrate,cmemo," +
                           ...
                           "Values( 8169," + iIDArr + ",'" + sRDCode + "','02','" + date1.ToString("yyyy-MM-dd") + "','" + dr2[i]["供应商编码"].ToString().Trim() + "','" + sDepCode + "',NULL,NULL,NULL,N'人民币',1,17,NULL, " +
            ...
            for (int i = 0; i < dr.Length; i++)
            {
                if (dr[i]["bUsed"].ToString().Trim() == "-1")
                {
                    ...
                    sSQL = "Insert Into @u8.PU_ArrivalVouch(ivtid,id,ccode,cptcode,ddate,cvencode,cdepcode,cpersoncode,cpaycode,csccode,cexch_name,iexchrate,itaxrate,cmemo," +
                           ...
                           "Values( 8169," + iIDArr + ",'" + sRDCode + "','01','" + date1.ToString("yyyy-MM-dd") + "','" + dr[i]["供应商编码"].ToString().Trim() + "','" + sDepCode + "',null,'03',NULL,N'人民币',1,17,NULL, " +
