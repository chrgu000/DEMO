...
namespace Purchase.DAL
{
    ...
    public partial class PurBillVouch
    {
        ...
        /// 增加一条数据
        /// </summary>
        public string Add(Purchase.Model.PurBillVouch model)
        {
            ...
            if (model.bMerger != null)
            {
                strSql1.Append("bMerger,");
                strSql2.Append("" + model.bMerger + ",");
            }
            strSql.Append("insert into @u8.PurBillVouch(");
