        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    string sSQL = @"
delete _科目对照
where 年度 = aaaaaa and 会计科目 in (select cCode from code where iYear = aaaaaa and isnull(bend,0) = 0 )
";
                    sSQL = sSQL.Replace("aaaaaa", lookUpEditiYear.EditValue.ToString().Trim());
