...
Select distinct a.cInvCode,b.cInvName,b.cInvStd,a.cVenCode,d.cVenName,cast (null as decimal(16,0)) as AllMonth,b.iInvAdvance 
	...
	,cast (null as decimal(16,0)) as OrderQty,cast (e.cComUnitName as varchar(50)) as PM,cast (null as datetime) as ETA,e.cComunitCode
into _TempTH_Sales
...
from (
	select sum(iQuantity - isnull(b.iReceivedQTY,0) - isnull(iarrQty,0)) as OnLoadQty,b.cInvCode,a.cVenCode
	...
	group by  b.cInvCode,a.cVenCode
	having sum(iQuantity - isnull(b.iReceivedQTY,0) - isnull(iarrQty,0)) > 0 
)a 
where a.cInvCode = _TempTH_Sales.cinvcode and a.cVenCode = _TempTH_Sales.cVenCode
