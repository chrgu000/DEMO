...
namespace clsU8
{
    ...
    public class ClsExcel
    {
        ...
        public DataTable dtExcelSheetName(string filepath)
        {
            string strConn = "Provider=Microsoft.Ace.OLEDB.12.0;Data Source=" + filepath + ";Extended Properties='Excel 12.0;HDR=Yes;IMEX=2'";
