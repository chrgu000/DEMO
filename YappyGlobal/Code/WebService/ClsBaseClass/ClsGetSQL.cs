...
namespace ClsBaseClass
{
    public class ClsGetSQL
    {
        ...
        {
            return GetDeleteSQL(ClsBaseClass.ClsBaseDataInfo.sDataBaseName, sTableName, dtTemp, iRow);
        }
        ...
        {
            return GetUpdateSQL(ClsBaseClass.ClsBaseDataInfo.sDataBaseName, sTableName, dtTemp, iRow);
        }
        ...
        {
            return GetInsertSQL(ClsBaseClass.ClsBaseDataInfo.sDataBaseName, sTableName, dtTemp, iRow);
        }
