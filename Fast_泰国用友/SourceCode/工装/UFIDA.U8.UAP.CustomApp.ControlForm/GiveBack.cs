...
{
    public partial class GiveBack : UserControl
    {
        ...
        {
            string sSQL = @"
select cCode from _GiveBack order by cCode
";
...
";
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                if (!clsUserRight.chkRight(sUserID, 5090))
        ...
        private void GetGrid()
        {
            ...
            string sSQL = @"
select a.[GUID],a.iID,a.cCode,a.dDate,a.Person,a.DepCode,a.Remark,a.CreateUserName,a.CreateDate,a.AuditUserName,a.AuditDate
	,b.GUIDHead,b.iID as iIDDetails,b.SerialNo,b.Remark as Remarks
from [dbo].[_GiveBack] a inner join [dbo].[_GiveBacks] b on a.[cCode] = b.cCode
where 1=1
...
";
        ...
        private void btnSEL_Click(object sender, EventArgs e)
        {
            try
            {
                if (!clsUserRight.chkRight(sUserID, 5010))
                    throw new Exception("没有权限");
        ...
        private void btnDEL_Click(object sender, EventArgs e)
        {
            try
            {
                if (!clsUserRight.chkRight(sUserID, 5040))
                    throw new Exception("没有权限");
                string sErr = "";
                try
                {
                ...
                try
                {
                        ...
                        string sSQL = "select * from  _GiveBack where cCode = N'111111'";
                        ...
                        sSQL = "update _FrockClamp set iState = 2 where SerialNo in (select SerialNo from _Requisitions where cCode = N'111111')";
                        sSQL = sSQL.Replace("111111", sCode);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                if (!clsUserRight.chkRight(sUserID, 5020))
                    throw new Exception("没有权限");

                GiveBack_Edit frm = new GiveBack_Edit(Conn, "");
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            try
            {
                if (!clsUserRight.chkRight(sUserID, 5030))
                    throw new Exception("没有权限");
                ...
                GiveBack_Edit frm = new GiveBack_Edit(Conn, sCode);
                frm.sUserName = this.sUserName;
                frm.sUserID = this.sUserID;
                frm.StartPosition = FormStartPosition.CenterParent;
                frm.ShowDialog();
