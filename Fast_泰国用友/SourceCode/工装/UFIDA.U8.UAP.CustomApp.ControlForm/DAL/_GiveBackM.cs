...
namespace UFIDA.U8.UAP.CustomApp.ControlForm.DAL
{
    ...
    /// 数据访问类:_GiveBackM
    /// </summary>
    public partial class _GiveBackM
    {
        public _GiveBackM()
        { }
        #region  Method
        ...
        /// 增加一条数据
        /// </summary>
        public string Add(UFIDA.U8.UAP.CustomApp.ControlForm.Model._GiveBackM model)
        {
            ...
            strSql.Append("insert into _GiveBackM(");
        ...
        /// 更新一条数据
        /// </summary>
        public string Update(UFIDA.U8.UAP.CustomApp.ControlForm.Model._GiveBackM model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update _GiveBackM set ");
            if (model.GUID != null)
            {
