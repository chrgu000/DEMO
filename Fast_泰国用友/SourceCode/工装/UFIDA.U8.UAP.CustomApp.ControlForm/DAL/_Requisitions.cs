...
namespace UFIDA.U8.UAP.CustomApp.ControlForm.DAL
{
    ...
    /// 数据访问类:_Requisitions
    /// </summary>
    public partial class _Requisitions
    {
        public _Requisitions()
        { }
        #region  Method
        ...
        /// 增加一条数据
        /// </summary>
        public string Add(UFIDA.U8.UAP.CustomApp.ControlForm.Model._Requisitions model)
        {
            ...
            strSql.Append("insert into _Requisitions(");
        ...
        /// 更新一条数据
        /// </summary>
        public string Update(UFIDA.U8.UAP.CustomApp.ControlForm.Model._Requisitions model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update _Requisitions set ");
            if (model.GUIDHead != null)
            {
