...
namespace UFIDA.U8.UAP.CustomApp.ControlForm.DAL
{
    ...
    public partial class _GiveBacks
    {
        ...
        /// 增加一条数据
        /// </summary>
        public string Add(UFIDA.U8.UAP.CustomApp.ControlForm.Model._GiveBacks model)
        {
            ...
            if (model.RequisitionsiID != null)
            {
                strSql1.Append("RequisitionsiID,");
                strSql2.Append("" + model.RequisitionsiID + ",");
            }
            if (model.Times != null)
            {
            ...
            strSql.Append("insert into _GiveBacks(");
        ...
        /// 更新一条数据
        /// </summary>
        public string Update(UFIDA.U8.UAP.CustomApp.ControlForm.Model._GiveBacks model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update _GiveBacks set ");
            if (model.GUIDHead != null)
            {
            ...
            if (model.RequisitionsiID != null)
            {
                strSql.Append("RequisitionsiID=" + model.RequisitionsiID + ",");
            }
            else
            {
                strSql.Append("RequisitionsiID= null ,");
            }
            if (model.Times != null)
            {
