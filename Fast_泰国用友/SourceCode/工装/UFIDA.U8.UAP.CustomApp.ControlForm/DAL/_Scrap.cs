...
namespace UFIDA.U8.UAP.CustomApp.ControlForm.DAL
{
    ...
    public partial class _Scrap
    {
        ...
        /// 增加一条数据
        /// </summary>
        public string Add(UFIDA.U8.UAP.CustomApp.ControlForm.Model._Scrap model)
        {
            ...
            strSql.Append("insert into _Scrap(");
        ...
        /// 更新一条数据
        /// </summary>
        public string Update(UFIDA.U8.UAP.CustomApp.ControlForm.Model._Scrap model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update _Scrap set ");
            if (model.GUID != null)
            {
