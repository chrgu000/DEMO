...
";
            ...
            //iState 0 新增,1 可用，2 已维修，3 维修，4 报废
            sSQL = @"
...
";
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                if (!clsUserRight.chkRight(sUserID, 3590))
...
from [dbo].[_Maintenance] a inner join [dbo].[_Maintenances] b on a.[cCode] = b.cCode
where 1=1
...
";
        ...
        private void btnSEL_Click(object sender, EventArgs e)
        {
            try
            {
                if (!clsUserRight.chkRight(sUserID, 3510))
                    throw new Exception("没有权限");
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                if (!clsUserRight.chkRight(sUserID, 3520))
                    throw new Exception("没有权限");


                Maintenance_Edit frm = new Maintenance_Edit(Conn, "");
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            try
            {
                if (!clsUserRight.chkRight(sUserID, 3530))
                    throw new Exception("没有权限");
                ...
                Maintenance_Edit frm = new Maintenance_Edit(Conn, sCode);
                frm.sUserName = this.sUserName;
                frm.sUserID = this.sUserID;
                frm.StartPosition = FormStartPosition.CenterParent;
                frm.ShowDialog();
        ...
        private void btnchk_Click(object sender, EventArgs e)
        {
            try
            {
                if (!clsUserRight.chkRight(sUserID, 3550))
                    throw new Exception("没有权限");
