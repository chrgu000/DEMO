...
{
    public partial class FrmSEL_ImportRdrecord01 : Form
    {
        public FrmSEL_ImportRdrecord01()
        {
            InitializeComponent();
        }
...
";
                ...
                {
                    sSQL = sSQL.Replace("1=1", "1=1 and ContainerNO like '%" + txtContainerNO.Text.Trim() + "%'");
                }
