...
namespace UFIDA.U8.UAP.CustomApp.ControlForm.DAL
{
    ...
    public partial class _部门费用登记
    {
        ...
        /// 增加一条数据
        /// </summary>
        public string Add(UFIDA.U8.UAP.CustomApp.ControlForm.Model._部门费用登记 model)
        {
            ...
            strSql.Append("insert into _部门费用登记(");
        ...
        /// 更新一条数据
        /// </summary>
        public string Update(UFIDA.U8.UAP.CustomApp.ControlForm.Model._部门费用登记 model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update _部门费用登记 set ");
            if (model.金额 != null)
            {
            ...
            strSql.Remove(n, 1);
            strSql.Append(" where 费用类型='" + model.费用类型 + "' and 会计期间='" + model.会计期间 + "' and 部门='" + model.部门 + "' ");
             return (strSql.ToString());
        }
        #endregion  Method
        #region  MethodEx
