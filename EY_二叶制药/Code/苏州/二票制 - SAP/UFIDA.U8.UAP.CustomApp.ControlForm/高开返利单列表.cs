...
{
    public partial class 高开返利单列表 : UserControl
    {
        ...
        private void gridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (sCode != "")
            {
                Frm高开返利单窗体 frm = new Frm高开返利单窗体(sCode, Conn, sUserID, sUserName, sLogDate, sAccID);
...
";
            ...
            sSQL = @"
select distinct cCode from [dbo].[_高开返利单] order by cCode
";
            dt = DbHelperSQL.Query(sSQL);
            dr = dt.NewRow();
            dt.Rows.InsertAt(dr, 0);
