...
namespace UFIDA.U8.UAP.CustomApp.ControlForm.DAL
{
    ...
    public partial class _高开返利单
    {
        ...
        /// 增加一条数据
        /// </summary>
        public string Add(UFIDA.U8.UAP.CustomApp.ControlForm.Model._高开返利单 model)
        {
            ...
            strSql.Append("insert into _高开返利单(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from _高开返利单 ");
