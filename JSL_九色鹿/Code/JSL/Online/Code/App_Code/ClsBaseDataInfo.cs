...
namespace 系统服务
{
    ...
    public class ClsBaseDataInfo
    {
        ...
        /// 本地服务器
        /// </summary>
        public static string sLocal = "";

        /// <summary>
        /// 连接字符串
        /// </summary>
        public static string sConnString = WebConfigurationManager.ConnectionStrings["ConnectionString1"].ToString();
        ...
        public static string sWebURL = "http://tanghui-rqsw.oicp.net:19835/RQSWSer/DBService.asmx";
