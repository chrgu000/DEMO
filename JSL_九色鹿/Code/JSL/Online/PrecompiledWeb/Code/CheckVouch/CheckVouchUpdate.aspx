<%@ page language="C#" autoeventwireup="true" inherits="CheckVouch_CheckVouchUpdate, App_Web_mw81buij" enableeventvalidation="true" stylesheettheme="Css" %>
...
<body>
    ...
    <YxControls:YxButtonUpdateTop ID="YxBtnTop" runat="server" Title="盘点单" />
    <table class="TableUpdate">
        <tr>
            ...
            <tr>
                ...
                <td class="tdinput" colspan="2">
                    <asp:RadioButton ID="r1" GroupName="r11" runat="server" Text="物料" Checked="true" />
                    <asp:RadioButton ID="r2" GroupName="r11" runat="server" Text="色号" />
                    <asp:RadioButton ID="r3" GroupName="r11" runat="server" Text="缸号" />
                </td>
            </tr>
            <td class="tdlbl">
                盒号
...
<script language="javascript" type="text/javascript">
    ...
    function doSave() {
        ...
        var s = AjaxMethod.GetCheckVouch(snew, ddate.value, flag, txtcPosCode.value).value;
        if (s == "保存成功") {
            alert("盘点单保存成功，请继续");
