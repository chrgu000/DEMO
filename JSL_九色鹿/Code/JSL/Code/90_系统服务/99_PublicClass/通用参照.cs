...
namespace 系统服务
{
    public static class LookUp
    {
        ...
        public static DataTable Inventory(bool istm)
        {
            return Inventory("", istm);
        }

        public static DataTable Inventory(string par,bool istm)
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
            string sSQL = @"select i.cInvCode,i.cInvName,i.cInvAddCode,i.cInvStd,i.cInvVenCode from Inventory i left join InventoryContrast ic on i.cInvCode=ic.cInvCode  where 1=1 and ic.cInvCode is not null";
            if (par != "")
            {
                sSQL = sSQL + " and i.cInvCode='" + par + "'";
            }
            sSQL = sSQL + " order by i.cInvCode ";
            return clsSQLCommond.ExecQuery(sSQL);
        }

        public static void Inventory(DevExpress.XtraEditors.LookUpEdit lookup, bool istm)
        {
            lookup.Properties.Columns.Clear();
            lookup.Properties.DataSource = Inventory(istm);
            lookup.Properties.ValueMember = "cInvCode";
            lookup.Properties.DisplayMember = "cInvName";
            lookup.Properties.NullText = "";
            lookup.Properties.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
        ...
        public static void Inventory(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup, bool istm)
        {
            lookup.Columns.Clear();
            lookup.Properties.DataSource = Inventory(istm);
            lookup.Properties.ValueMember = "cInvCode";
        ...
        public static void InventoryVenCode(DevExpress.XtraEditors.LookUpEdit lookup)
        {
            lookup.Properties.Columns.Clear();
            lookup.Properties.DataSource = Inventory();
            lookup.Properties.ValueMember = "cInvCode";
        ...
        public static void InventoryVenCode(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            lookup.Columns.Clear();
            lookup.Properties.DataSource = Inventory();
            lookup.Properties.ValueMember = "cInvCode";
        ...
        /// <param name="par"></param>
        /// <returns></returns>
        public static DataTable Position(string cWhCode)
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
            string sSQL = @"select cPosCode,cPosName,a.cWhCode,b.cWhName from Position a left join Warehouse b on a.cWhCode=b.cWhCode  where 1=1 ";
            if (cWhCode != "")
            {
                sSQL = sSQL + " and a.cWhCode='" + cWhCode + "'";
            }
            sSQL = sSQL + " order by cPosCode ";
            return clsSQLCommond.ExecQuery(sSQL);
        }

        public static void Position(DevExpress.XtraEditors.LookUpEdit lookup, string cWhCode)
        {
            lookup.Properties.Columns.Clear();
            lookup.Properties.DataSource = Position(cWhCode);
            lookup.Properties.ValueMember = "cPosCode";
            lookup.Properties.DisplayMember = "cPosName";
            lookup.Properties.NullText = "";
            lookup.Properties.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("cPosCode", "货位编码"),
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("cWhName", "货位名称"),
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("cWhCode", "仓库编码"),
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("cWhName", "仓库名称")});
        }

        public static void Position(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup, string cWhCode)
        {
            lookup.Columns.Clear();
            lookup.Properties.DataSource = Position(cWhCode);
            lookup.Properties.ValueMember = "cPosCode";
        ...
        public static DataTable Position()
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
            string sSQL = @"select cPosCode,cPosName,a.cWhCode,b.cWhName from Position a left join Warehouse b on a.cWhCode=b.cWhCode  where 1=1 ";
            sSQL = sSQL + " order by cPosCode ";
        ...
        public static void Position(DevExpress.XtraEditors.LookUpEdit lookup)
        {
            lookup.Properties.Columns.Clear();
            lookup.Properties.DataSource = Position();
            lookup.Properties.ValueMember = "cPosCode";
            lookup.Properties.DisplayMember = "cPosName";
            lookup.Properties.NullText = "";
            lookup.Properties.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
        ...
        public static void Position(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            lookup.Columns.Clear();
            lookup.Properties.DataSource = Position();
            lookup.Properties.ValueMember = "cPosCode";
        ...
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
            string sSQL = @"select cRSCode,cRSName from RdStyle where  收发标志=" + type + " ";
            lookup.Properties.Columns.Clear();
        ...
        public static void RdStyle(DevExpress.XtraEditors.LookUpEdit lookup, int type, string cRSCode)
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
            string sSQL = @"select cRSCode,cRSName from RdStyle where  收发标志=" + type + " and cRSCode in(" + cRSCode + ")";
            lookup.Properties.Columns.Clear();
            lookup.Properties.DataSource = clsSQLCommond.ExecQuery(sSQL);
            lookup.Properties.ValueMember = "cRSCode";
            lookup.Properties.DisplayMember = "cRSName";
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable RdRecord13()
        {
            return RdRecord13("");
        }
        /// <summary>
        ...
        /// <returns></returns>
        public static DataTable RdRecord13(string par)
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
            string sSQL = @"select ID,cRDCode from RdRecord13 where 1=1  ";
            if (par != "")
            {
                sSQL = sSQL + " and ID='" + par + "'";
            }
        ...
        public static void RdRecord13(DevExpress.XtraEditors.LookUpEdit lookup)
        {
            lookup.Properties.DataSource = RdRecord13();
            lookup.Properties.ValueMember = "cRDCode";
            lookup.Properties.DisplayMember = "cRDCode";
            lookup.Properties.NullText = "";
            lookup.Properties.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("cRDCode","销售出库单号")});
        }
        #endregion
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable SO_SOPackingMain()
        {
            return SO_SOPackingMain("");
        }
        /// <summary>
        /// 销售出库单
        /// </summary>
        /// <param name="par">销售出库单号</param>
        /// <returns></returns>
        public static DataTable SO_SOPackingMain(string par)
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
        ...
        public static void SO_SOPackingMain(DevExpress.XtraEditors.LookUpEdit lookup)
        {
            lookup.Properties.DataSource = SO_SOPackingMain();
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable DispatchList()
        {
            return DispatchList("");
        }
        /// <summary>
        /// 销售发货单
        /// </summary>
        /// <param name="par">销售发货单</param>
        /// <returns></returns>
        public static DataTable DispatchList(string par)
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
            string sSQL = @"select ID,cDLCode from DispatchList where 1=1 ";
            if (par != "")
            {
                sSQL = sSQL + " and ID='" + par + "'";
            }
        ...
        public static void DispatchList(DevExpress.XtraEditors.LookUpEdit lookup)
        {
            lookup.Properties.Columns.Clear();
            lookup.Properties.DataSource = DispatchList();
            lookup.Properties.ValueMember = "ID";
            lookup.Properties.DisplayMember = "cDLCode";
            lookup.Properties.NullText = "";
            lookup.Properties.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
                new DevExpress.XtraEditors.Controls.LookUpColumnInfo("ID","销售发货单"),
                new DevExpress.XtraEditors.Controls.LookUpColumnInfo("cDLCode","销售发货单号")});
        }

        public static void DispatchList(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            lookup.Properties.Columns.Clear();
            lookup.Properties.DataSource = SO_SOMain();
            lookup.Properties.ValueMember = "ID";
        ...
        /// </summary>
        /// <returns></returns>
        public static DataTable PO_PODetails()
        {
            return PO_PODetails("");
        }
        /// <summary>
        ...
        /// <param name="par">采购订单号</param>
        /// <returns></returns>
        public static DataTable PO_PODetails(string par)
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
            string sSQL = @"select AutoID,cPOCode from PO_PODetails where 1=1 ";
            if (par != "")
            {
                sSQL = sSQL + " and AutoID='" + par + "'";
            }
            sSQL = sSQL + " order by AutoID ";
            return clsSQLCommond.ExecQuery(sSQL);
        }

        public static void PO_PODetails(DevExpress.XtraEditors.LookUpEdit lookup)
        {
            lookup.Properties.Columns.Clear();
            lookup.Properties.DataSource = PO_PODetails();
            lookup.Properties.ValueMember = "AutoID";
            lookup.Properties.DisplayMember = "cPOCode";
            lookup.Properties.NullText = "";
            lookup.Properties.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
        ...
        public static void PO_PODetails(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            lookup.Properties.Columns.Clear();
            lookup.Properties.DataSource = PO_PODetails();
            lookup.Properties.ValueMember = "AutoID";
        ...
        public static DataTable RdRecord(string cRSCode,string 收发标志, string par)
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
            string sSQL = @"
select ID,cRSCode,cRdCode into #a from RdRecord01
insert into #a select ID,cRSCode,cRdCode from RdRecord02
insert into #a select ID,cRSCode,cRdCode from RdRecord03
insert into #a select ID,cRSCode,cRdCode from RdRecord05

insert into #a select ID,cRSCode,cRdCode from RdRecord11
insert into #a select ID,cRSCode,cRdCode from RdRecord12
insert into #a select ID,cRSCode,cRdCode from RdRecord13
insert into #a select ID,cRSCode,cRdCode from RdRecord15

select ID,cRdCode from #a a left join RdStyle b on a.cRSCode=b.cRSCode where 1=1 ";
            //if (par != "")
            //{
            //    sSQL = sSQL + " and ID='" + par + "'";
            //}
        ...
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
            string sSQL = @"select AutoID,cRdCode  from RdRecords01 where 1=1 
insert into #a select AutoID,cRdCode from RdRecords02 where 1=1 
insert into #a select AutoID,cRdCode from RdRecords03 where 1=1 
insert into #a select AutoID,cRdCode from RdRecords05 where 1=1 
select * from #a ";
            sSQL = sSQL + " order by AutoID ";
            return clsSQLCommond.ExecQuery(sSQL);
        }
        ...
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
            string sSQL = @"select cMSCode,cMSName,b.cWhName as 转出仓库,c.cWhName as 转入仓库,d.cDepName as 转出部门,f.cDepName as 转入部门 
            from MOStyle a left join Warehouse b on a.S1=b.cWhCode 
            ...
            if (par != "")
            {
                sSQL = sSQL + " and cMSCode='" + par + "'";
            }
            sSQL = sSQL + " order by cMSCode ";
            return clsSQLCommond.ExecQuery(sSQL);
        }
        ...
        public static void MOStyle(DevExpress.XtraEditors.LookUpEdit lookup)
        {
            ...
            lookup.Properties.ValueMember = "cMSCode";
            lookup.Properties.DisplayMember = "cMSName";
            lookup.Properties.NullText = "";
            lookup.Properties.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("cMSCode", "委外工序编码"),
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("cMSName", "委外工序名称"),
            ...
            lookup.Properties.Columns[0].Width = 70;
            lookup.Properties.Columns[1].Width = 70;
            lookup.Properties.Columns[2].Width = 70;
            lookup.Properties.Columns[3].Width = 70;
            lookup.Properties.Columns[4].Width = 70;
            lookup.Properties.Columns[5].Width = 70;
        ...
        public static void MOStyle(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            ...
            lookup.Properties.Columns[3].Width = 20;
            lookup.Properties.Columns[4].Width = 20;
            lookup.Properties.Columns[5].Width = 20;
        }

        public static void MOStyle(DevExpress.XtraGrid.GridControl gridControl, DevExpress.XtraGrid.Columns.GridColumn gridCol)
        {
            ...
            item.NullStyle = DevExpress.XtraEditors.Controls.StyleIndeterminate.Unchecked;
            gridControl.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] { item });
        ...
        public static DataTable MO_MOSublist()
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
            string sSQL = @"select sID,cMOCode   from MO_MOSublist  where 1=1 ";
            sSQL = sSQL + " order by sID ";
            return clsSQLCommond.ExecQuery(sSQL);
        }

        public static void MO_MOSublist(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            lookup.Columns.Clear();
            lookup.Properties.DataSource = MO_MOSublist();
            lookup.Properties.ValueMember = "sID";
            lookup.Properties.DisplayMember = "cMOCode";
            lookup.Properties.NullText = "";
            lookup.Properties.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("cMOCode","委外订单号")});
        ...
        public static DataTable MO_MODetails()
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
            string sSQL = @"select AutoID,cMOCode   from MO_MODetails  where 1=1 ";
            sSQL = sSQL + " order by AutoID ";
            return clsSQLCommond.ExecQuery(sSQL);
        }

        public static void MO_MODetails(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            lookup.Columns.Clear();
            lookup.Properties.DataSource = MO_MODetails();
            lookup.Properties.ValueMember = "AutoID";
            lookup.Properties.DisplayMember = "cMOCode";
            lookup.Properties.NullText = "";
            lookup.Properties.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
        ...
        /// <param name="par"></param>
        /// <returns></returns>
        public static DataTable CheckVouch()
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
            string sSQL = @"select ID,CheckCode   from CheckVouch  where 1=1 ";
            sSQL = sSQL + " order by ID ";
            return clsSQLCommond.ExecQuery(sSQL);
        }

        public static void CheckVouch(DevExpress.XtraEditors.LookUpEdit lookup)
        {
            lookup.Properties.Columns.Clear();
            lookup.Properties.DataSource = CheckVouch();
            lookup.Properties.ValueMember = "CheckCode";
            lookup.Properties.DisplayMember = "CheckCode";
            lookup.Properties.NullText = "";
            lookup.Properties.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("CheckCode","盘点单号")});
        }
        public static void CheckVouch(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            lookup.Columns.Clear();
            lookup.Properties.DataSource = CheckVouch();
            lookup.Properties.ValueMember = "CheckCode";
        ...
        public static DataTable CheckVouchs()
        {
            系统服务.ClsDataBase clsSQLCommond = 系统服务.ClsDataBaseFactory.Instance();
            string sSQL = @"select AutoID,CheckCode   from CheckVouchs  where 1=1 ";
            sSQL = sSQL + " order by AutoID ";
            return clsSQLCommond.ExecQuery(sSQL);
        }

        public static void CheckVouchs(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            lookup.Columns.Clear();
            lookup.Properties.DataSource = CheckVouchs();
            lookup.Properties.ValueMember = "CheckCode";
            lookup.Properties.DisplayMember = "CheckCode";
            lookup.Properties.NullText = "";
            lookup.Properties.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
