...
namespace 系统服务
{
    public class ClsU8Function
    {
        ...
        系统服务.ClsGetSQL clsGetSQL = new 系统服务.ClsGetSQL();
        ...
        private string sSetRDOutCode(long s)
        {
            ...
            return "OO" + DateTime.Parse(系统服务.ClsBaseDataInfo.sLogDate).ToString("yyMM") + sCode;
        }
        ...
        private string sSetRDInCode(long s)
        {
            ...
            return "IO" + DateTime.Parse(系统服务.ClsBaseDataInfo.sLogDate).ToString("yyMM") + sCode;
        }
        ...
        public ArrayList GenInvChangeRD(DataTable dtHead, DataTable dtDetail, long iID, long iIDDetail, out long iID2, out long iIDDetail2, long iInCode, out long iInCode2,long iOutCode,out long iOutCode2)
        {
            ...
            drRd["dDate"] = 系统服务.ClsBaseDataInfo.sLogDate;
            ...
            drRd["cMaker"] = 系统服务.ClsBaseDataInfo.sUserName;
            ...
            drRd["dnmaketime"] = 系统服务.ClsBaseDataInfo.sLogDate;
            ...
            aList.Add(clsGetSQL.GetInsertSQL(系统服务.ClsBaseDataInfo.sUFDataBaseName, "RdRecord", dtRdrecord, 0));

            //更改最大入库单据号
            sSQL = "select count(*) as iCount From @u8.VoucherHistory  with (NOLOCK) Where CardNumber='0301' and (cContent='日期' or cContent='单据日期') and (cSeed='" + DateTime.Parse(系统服务.ClsBaseDataInfo.sLogDate).ToString("yyyyMM") + "' or cSeed='" + DateTime.Parse(系统服务.ClsBaseDataInfo.sLogDate).ToString("yyMM") + "')";
            DataTable dtCodeTemp = clsSQL.ExecQuery(sSQL);
            if (dtCodeTemp.Rows[0]["iCount"].ToString().Trim() == "0")
            {
                sSQL = "insert into @u8.VoucherHistory(cardnumber,ccontent,ccontentrule,cseed,cnumber,bempty)values('0301','日期','月','" + DateTime.Parse(系统服务.ClsBaseDataInfo.sLogDate).ToString("yyMM") + "','1',0)";
                aList.Add(sSQL);
            }
            else
            {
                sSQL = "update @u8.VoucherHistory set cNumber = '" + iInCode.ToString().Trim() + "' Where CardNumber='0301' and (cContent='日期' or cContent='单据日期') and (cSeed='" + DateTime.Parse(系统服务.ClsBaseDataInfo.sLogDate).ToString("yyyyMM") + "' or cSeed='" + DateTime.Parse(系统服务.ClsBaseDataInfo.sLogDate).ToString("yyMM") + "')";
                aList.Add(sSQL);
            }
            iInCode2 = iInCode;
            #endregion
            ...
            for (int i = 0; i < dtDetail.Rows.Count; i++)
            {
                ...
                aList.Add(clsGetSQL.GetInsertSQL(系统服务.ClsBaseDataInfo.sUFDataBaseName, "RdRecords", dtRdrecords, i));
            ...
            //更改最大出库单据号
            sSQL = "select count(*) as iCount From @u8.VoucherHistory  with (NOLOCK) Where CardNumber='0302' and (cContent='日期' or cContent='单据日期') and (cSeed='" + DateTime.Parse(系统服务.ClsBaseDataInfo.sLogDate).ToString("yyyyMM") + "' or cSeed='" + DateTime.Parse(系统服务.ClsBaseDataInfo.sLogDate).ToString("yyMM") + "')";
            dtCodeTemp = clsSQL.ExecQuery(sSQL);

            if (dtCodeTemp.Rows[0]["iCount"].ToString().Trim() == "0")
            {
                sSQL = "insert into @u8.VoucherHistory(cardnumber,ccontent,ccontentrule,cseed,cnumber,bempty)values('0302','日期','月','" + DateTime.Parse(系统服务.ClsBaseDataInfo.sLogDate).ToString("yyMM") + "','1',0)";
                aList.Add(sSQL);
            }
            else
            {
                sSQL = "update @u8.VoucherHistory set cNumber = '" + iOutCode.ToString().Trim() + "' Where CardNumber='0302' and (cContent='日期' or cContent='单据日期') and (cSeed='" + DateTime.Parse(系统服务.ClsBaseDataInfo.sLogDate).ToString("yyyyMM") + "' or cSeed='" + DateTime.Parse(系统服务.ClsBaseDataInfo.sLogDate).ToString("yyMM") + "')";
                aList.Add(sSQL);
            }
            iOutCode2 = iOutCode;
            #endregion
            ...
            sSQL = "update UFSystem..UA_Identity set iFatherID = " + iID + ",iChildID=" + iIDDetail + "  where cAcc_Id = '" + 系统服务.ClsBaseDataInfo.sUFDataBaseName.Substring(7, 3) + "' and cVouchType = 'rd'";
            aList.Add(sSQL);
