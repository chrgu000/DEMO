namespace 天猫 
{
    partial class Frm天猫入库列表
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.gridCol已用卷数 = new DevExpress.XtraGrid.Columns.GridColumn();
            ...
            // gridColRdAutoID
            // 
            this.gridColRdAutoID.Caption = "入库单子表序号";
            ...
            this.gridCol卷数.Summary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum)});
            this.gridCol卷数.Visible = true;
            this.gridCol卷数.VisibleIndex = 9;
            // 
            // gridColM1
            // 
            ...
            // gridCol已用卷数
            // 
            this.gridCol已用卷数.Caption = "已用卷数";
            this.gridCol已用卷数.FieldName = "OutiSubQty";
            this.gridCol已用卷数.Name = "gridCol已用卷数";
            this.gridCol已用卷数.OptionsColumn.AllowEdit = false;
            this.gridCol已用卷数.Visible = true;
            this.gridCol已用卷数.VisibleIndex = 11;
            // 
            // ItemLookUpEdit仓库
            // 
            ...
            this.Name = "Frm天猫入库列表";
            this.Text = "天猫入库列表";
            this.Load += new System.EventHandler(this.Frm天猫入库列表_Load);
        ...
        private DevExpress.XtraGrid.Columns.GridColumn gridCol已用卷数;
    }
}