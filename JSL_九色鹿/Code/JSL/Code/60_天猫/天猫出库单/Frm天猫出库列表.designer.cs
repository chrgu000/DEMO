namespace 天猫 
{
    partial class Frm天猫出库列表
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.gridCol卷数 = new DevExpress.XtraGrid.Columns.GridColumn();
            this.gridCol盒号 = new DevExpress.XtraGrid.Columns.GridColumn();
            this.gridCol是否导入 = new DevExpress.XtraGrid.Columns.GridColumn();
            this.gridCol单卷数量 = new DevExpress.XtraGrid.Columns.GridColumn();
            ...
            this.gridColRdAutoID.VisibleIndex = 14;
            // 
            // gridColM1
            // 
            ...
            // gridCol卷数
            // 
            this.gridCol卷数.Caption = "卷数";
            this.gridCol卷数.FieldName = "iSubQty";
            this.gridCol卷数.Name = "gridCol卷数";
            this.gridCol卷数.OptionsColumn.AllowEdit = false;
            this.gridCol卷数.Visible = true;
            this.gridCol卷数.VisibleIndex = 8;
            // 
            // gridCol盒号
            // 
            ...
            // gridCol是否导入
            // 
            this.gridCol是否导入.Caption = "是否导入";
            this.gridCol是否导入.FieldName = "iImport";
            this.gridCol是否导入.Name = "gridCol是否导入";
            this.gridCol是否导入.OptionsColumn.AllowEdit = false;
            this.gridCol是否导入.Visible = true;
            this.gridCol是否导入.VisibleIndex = 23;
            // 
            // gridCol单卷数量
            // 
            this.gridCol单卷数量.Caption = "单卷数量";
            this.gridCol单卷数量.FieldName = "iUnitQty";
            this.gridCol单卷数量.Name = "gridCol单卷数量";
            this.gridCol单卷数量.OptionsColumn.AllowEdit = false;
            this.gridCol单卷数量.Visible = true;
            this.gridCol单卷数量.VisibleIndex = 10;
            // 
            // ItemLookUpEdit物料代码
            // 
            ...
            this.Name = "Frm天猫出库列表";
            this.Text = "天猫出库列表";
            this.Load += new System.EventHandler(this.Frm天猫出库列表_Load);
        ...
        private DevExpress.XtraGrid.Columns.GridColumn gridCol卷数;
        private DevExpress.XtraGrid.Columns.GridColumn gridCol盒号;
        private DevExpress.XtraGrid.Columns.GridColumn gridCol是否导入;
        private DevExpress.XtraGrid.Columns.GridColumn gridCol单卷数量;
    }
}