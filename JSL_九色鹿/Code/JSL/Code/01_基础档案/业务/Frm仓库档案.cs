                ...
                try
                {
                    ...
                    for (int i = 0; i < gridView1.RowCount; i++)
                    {
                        if (gridView1.IsRowSelected(i))
                        {
                            ...
                            sSQL = "select count(1) from dbo.RdRecord01 where cWhCode = '" + sID + "' ";
                            ...
                            sSQL = "select count(1) from dbo.RdRecord02 where cWhCode = '" + sID + "' ";
                            ...
                            sSQL = "select count(1) from dbo.RdRecord03 where cWhCode = '" + sID + "' ";
                            iCou = Convert.ToInt64(clsSQLCommond.ExecGetScalar(sSQL));
                            if (iCou > 0)
                            {
                                sErr = "行" + (i + 1).ToString() + " " + sID + " 已经使用不能删除\n";
                            ...
                            sSQL = "select count(1) from dbo.RdRecord05 where cWhCode = '" + sID + "' ";
                            iCou = Convert.ToInt64(clsSQLCommond.ExecGetScalar(sSQL));
                            if (iCou > 0)
                            {
                                sErr = "行" + (i + 1).ToString() + " " + sID + " 已经使用不能删除\n";
                            ...
                            sSQL = "select count(1) from dbo.RdRecord11 where cWhCode = '" + sID + "' ";
                            iCou = Convert.ToInt64(clsSQLCommond.ExecGetScalar(sSQL));
                            if (iCou > 0)
                            {
                                sErr = "行" + (i + 1).ToString() + " " + sID + " 已经使用不能删除\n";
                            ...
                            sSQL = "select count(1) from dbo.RdRecord12 where cWhCode = '" + sID + "' ";
                            iCou = Convert.ToInt64(clsSQLCommond.ExecGetScalar(sSQL));
                            if (iCou > 0)
                            {
                                sErr = "行" + (i + 1).ToString() + " " + sID + " 已经使用不能删除\n";
                            ...
                            sSQL = "select count(1) from dbo.RdRecord15 where cWhCode = '" + sID + "' ";
                            iCou = Convert.ToInt64(clsSQLCommond.ExecGetScalar(sSQL));
                            if (iCou > 0)
                            {
                                sErr = "行" + (i + 1).ToString() + " " + sID + " 已经使用不能删除\n";
