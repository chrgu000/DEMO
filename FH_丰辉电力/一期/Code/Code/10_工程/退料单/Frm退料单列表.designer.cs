namespace 工程
{
    partial class Frm退料单列表 
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "Frm退料单列表";
            this.Text = "退料单列表";
            this.Load += new System.EventHandler(this.Frm退料单列表_Load);
