namespace 工程
{
    partial class Frm当月结存登记列表 
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.gridCol单据号.FieldName = "mRdCode";
            ...
            this.Name = "Frm当月结存登记列表";
            this.Text = "当月结存登记列表";
            this.Load += new System.EventHandler(this.Frm当月结存登记列表_Load);
