...
{
    public class PrintBarCode_OM_MOMainCreater : INetUserControl
    {
        ...
        System.Windows.Forms.Control INetUserControl.CreateControl(UFSoft.U8.Framework.Login.UI.clsLogin login, string MenuID, string Paramters)
        {
            ...
            {
                string sSQL = "select * from _UserRight where UserID = '" + sLogUserid + "' and FormID = '1020'";
            ...
            {
                PrintBarCode_OM_MOMain fm = new PrintBarCode_OM_MOMain();
                fm.Conn = conn;
