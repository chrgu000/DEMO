...
{
    public class PrintBarCode_RdRecord10Creater : INetUserControl
    {
        ...
        System.Windows.Forms.Control INetUserControl.CreateControl(UFSoft.U8.Framework.Login.UI.clsLogin login, string MenuID, string Paramters)
        {
            ...
            {
                string sSQL = "select * from _UserRight where UserID = '" + sLogUserid + "' and FormID = '1030'";
            ...
            {
                PrintBarCode_RdRecord10 fm = new PrintBarCode_RdRecord10();
                fm.Conn = conn;
