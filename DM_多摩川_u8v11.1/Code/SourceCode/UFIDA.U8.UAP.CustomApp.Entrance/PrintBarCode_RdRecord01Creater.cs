...
{
    public class PrintBarCode_RdRecord01Creater : INetUserControl
    {
        ...
        System.Windows.Forms.Control INetUserControl.CreateControl(UFSoft.U8.Framework.Login.UI.clsLogin login, string MenuID, string Paramters)
        {
            ...
            {
                string sSQL = "select * from _UserRight where UserID = '" + sLogUserid + "' and FormID = '1010'";
            ...
            {
                PrintBarCode_RdRecord01 fm = new PrintBarCode_RdRecord01();
                fm.Conn = conn;
