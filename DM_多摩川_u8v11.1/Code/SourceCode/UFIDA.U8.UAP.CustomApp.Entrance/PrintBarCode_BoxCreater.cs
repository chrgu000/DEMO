...
{
    public class PrintBarCode_BoxCreater : INetUserControl
    {
        ...
        System.Windows.Forms.Control INetUserControl.CreateControl(UFSoft.U8.Framework.Login.UI.clsLogin login, string MenuID, string Paramters)
        {
            ...
            {
                string sSQL = "select * from _UserRight where UserID = '" + sLogUserid + "' and FormID = '1060'";
            ...
            {
                PrintBarCode_Box fm = new PrintBarCode_Box();
