...
{
    public class PrintBarCode_InventoryCreater : INetUserControl
    {
        ...
        System.Windows.Forms.Control INetUserControl.CreateControl(UFSoft.U8.Framework.Login.UI.clsLogin login, string MenuID, string Paramters)
        {
            ...
            {
                string sSQL = "select * from _UserRight where UserID = '" + sLogUserid + "' and FormID = '1070'";
            ...
            {
                PrintBarCode_Inventory fm = new PrintBarCode_Inventory();
                fm.Conn = conn;
