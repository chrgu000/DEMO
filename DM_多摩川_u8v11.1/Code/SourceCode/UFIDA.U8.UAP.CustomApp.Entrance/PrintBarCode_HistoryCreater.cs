...
{
    public class PrintBarCode_HistoryCreater : INetUserControl
    {
        ...
        System.Windows.Forms.Control INetUserControl.CreateControl(UFSoft.U8.Framework.Login.UI.clsLogin login, string MenuID, string Paramters)
        {
            ...
            {
                string sSQL = "select * from _UserRight where UserID = '" + sLogUserid + "' and FormID = '1080'";
            ...
            else
            {
                ...
                PrintBarCode_History fm = new PrintBarCode_History();
                fm.Conn = conn;
