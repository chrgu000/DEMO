...
{
    public class PrintBarCode_mom_orderCreater : INetUserControl
    {
        ...
        System.Windows.Forms.Control INetUserControl.CreateControl(UFSoft.U8.Framework.Login.UI.clsLogin login, string MenuID, string Paramters)
        {
            ...
            {
                string sSQL = "select * from _UserRight where UserID = '" + sLogUserid + "' and FormID = '1040'";
            ...
            {
                PrintBarCode_mom_order fm = new PrintBarCode_mom_order();
                fm.Conn = conn;
