...
{
    public class PrintBarCode_RdRecord08Creater : INetUserControl
    {
        ...
        System.Windows.Forms.Control INetUserControl.CreateControl(UFSoft.U8.Framework.Login.UI.clsLogin login, string MenuID, string Paramters)
        {
            ...
            {
                string sSQL = "select * from _UserRight where UserID = '" + sLogUserid + "' and FormID = '1050'";
            ...
            {
                PrintBarCode_RdRecord08 fm = new PrintBarCode_RdRecord08();
                fm.Conn = conn;
