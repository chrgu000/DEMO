...
namespace TH.BaseClass
{
    public class BaseFunction
    {
        ...
        public static string ReturnStatus(string s)
        {
            string sStatus = s;
            switch (s)
            {
                case "新增": sStatus = "New"; break;
                case "新增-客供条码": sStatus = "New-with Barcode"; break;
                case "发货": sStatus = "Delivery"; break;
                case "关闭": sStatus = "Closed"; break;
                case "调整": sStatus = "Adjustment"; break;
                case "流转": sStatus = "Transfer"; break;
                default:
                    sStatus = s;
                    break;
            }
        ...
        ///// <param name="iYear2"></param>
        ///// <param name="iPeriod"></param>
        //public static void ReturniYPeriod(int iYear, int iMonth, out int iYear2, out int iPeriod)
        //{
        //    iYear2 = iYear;
