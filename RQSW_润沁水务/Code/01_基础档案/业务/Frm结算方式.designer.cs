namespace 基础设置
{
    partial class Frm结算方式
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.gridCol结算方式名称 = new DevExpress.XtraGrid.Columns.GridColumn();
            ...
            this.layoutControl1.Size = new System.Drawing.Size(762, 228);
            ...
            this.gridControl1.Size = new System.Drawing.Size(738, 204);
            ...
            // gridCol结算方式编码
            // 
            this.gridCol结算方式编码.AppearanceHeader.ForeColor = System.Drawing.Color.Blue;
            this.gridCol结算方式编码.AppearanceHeader.Options.UseForeColor = true;
            this.gridCol结算方式编码.Caption = "结算方式编码";
            this.gridCol结算方式编码.FieldName = "cSSCode";
            this.gridCol结算方式编码.Name = "gridCol结算方式编码";
            this.gridCol结算方式编码.OptionsColumn.AllowMerge = DevExpress.Utils.DefaultBoolean.False;
            this.gridCol结算方式编码.Visible = true;
            this.gridCol结算方式编码.VisibleIndex = 0;
            this.gridCol结算方式编码.Width = 122;
            // 
            // gridCol结算方式名称
            // 
            this.gridCol结算方式名称.AppearanceHeader.ForeColor = System.Drawing.Color.Blue;
            this.gridCol结算方式名称.AppearanceHeader.Options.UseForeColor = true;
            this.gridCol结算方式名称.Caption = "结算方式名称";
            this.gridCol结算方式名称.FieldName = "cSSName";
            this.gridCol结算方式名称.Name = "gridCol结算方式名称";
            this.gridCol结算方式名称.OptionsColumn.AllowMerge = DevExpress.Utils.DefaultBoolean.False;
            this.gridCol结算方式名称.Visible = true;
            this.gridCol结算方式名称.VisibleIndex = 1;
            this.gridCol结算方式名称.Width = 134;
            // 
            // gridColRemark
            // 
            ...
            this.layoutControlGroup1.Size = new System.Drawing.Size(762, 228);
            ...
            this.layoutControlItem3.Size = new System.Drawing.Size(742, 208);
            ...
            this.Name = "Frm结算方式";
            this.Text = "结算方式";
            this.Load += new System.EventHandler(this.Frm结算方式_Load);
        ...
        private DevExpress.XtraGrid.Columns.GridColumn gridCol结算方式名称;
