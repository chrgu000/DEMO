...
namespace FrameBaseFunction
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static string connectionString = FrameBaseFunction.ClsBaseDataInfo.sConnString;
        public DbHelperSQL()
        {
        }
        ...
        {
            return Convert.ToDateTime(Query("select getdate()").Tables[0].Rows[0][0]);
        }
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    for (int n = 0; n < SQLStringList.Count; n++)
                    {
                        ...
                        strsql = strsql.Replace("@u8", FrameBaseFunction.ClsBaseDataInfo.sUFDataBaseName + ".");
