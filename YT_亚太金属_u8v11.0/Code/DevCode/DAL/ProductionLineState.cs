...
namespace TH.DAL
{
    ...
    public partial class ProductionLineState
    {
        ...
        public bool CheckPC(DateTime dTime)
        {
            ...
            int iCou = 0;
            string sSQL = "select count(1) from dbo.生产工序日计划 where 排产日期 = '111111'";
            sSQL = sSQL.Replace("111111", dTime.ToString("yyyy-MM-dd"));
            DataTable dt = DbHelperSQL.Query(sSQL).Tables[0];
            if (dt != null && dt.Rows.Count > 0)
            {
        ...
        {
            string sSQL = @"
select b.iID,b.GUID, a.WcCode as [LineNo],a.Description as LineName,b.CreateUid,b.CreateDate,b.UpdateUid,b.UpdateDate,isnull(b.[State],0) as [State],b.dDate,b.Remark 
from @u8.sfc_workcenter a left join dbo.ProductionLineState b on a.[WcCode] = b.[LineNo] and dDate = '111111'
order by a.WcCode
";
...
";
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from ProductionLineState T ");
