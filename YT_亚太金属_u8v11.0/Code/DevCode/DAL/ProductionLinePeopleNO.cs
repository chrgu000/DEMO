...
namespace TH.DAL
{
    ...
    public partial class ProductionLinePeopleNO
    {
        ...
        public DataSet GetMonthList(string strWhere)
        {
            ...
            string sSQL = @"
select a.[LineNo] ,b.Description as LineName
...
from ProductionLinePeopleNO a inner join @u8.sfc_workcenter b on a.[LineNo] = b.[WcCode]
where a.dDate >= '111111' and a.dDate < '222222'
group by a.[LineNo] ,b.Description
order by a.[LineNo] ,b.Description
";
        ...
        {
            string sSQL = @"
select a.WcCode as [LineNO],a.Description as LineName,b.iID, b.GUID, b.CreateUid, b.CreateDate, b.UpdateUid, b.UpdateDate, b.dDate, b.PeopleNO, b.Remark 
	,isnull(d.iText,0) as 状态 
from @u8.sfc_workcenter a 
	left join ProductionLineState c on a.[WcCode] = c.[LineNO] and c.dDate = '111111' 
    left join dbo.ProductionLinePeopleNO b on a.[WcCode] = b.[LineNO] and b.dDate = '111111' 
...
";
        ...
        {
            string sSQL = @"
select a.WcCode as [LineNO],a.Description as LineName,b.iID, b.GUID, b.CreateUid, b.CreateDate, b.UpdateUid, b.UpdateDate, b.dDate, e.Remark as PeopleNO, b.Remark 
	,isnull(d.iText,0) as 状态 
from @u8.sfc_workcenter a 
	left join ProductionLineState c on a.[WcCode] = c.[LineNO] and c.dDate = '111111' 
    left join dbo.ProductionLinePeopleNO b on a.[WcCode] = b.[LineNO] and b.dDate = '111111' 
	left join _LookUpDate d on isnull(d.iID,0) = isnull(c.[State],0) and d.iType = '01'
    left join _LookUpDate e on e.iID = a.WcCode and e.iType = '02'
order by a.[WcCode]
";
            sSQL = sSQL.Replace("111111", strWhere);
            return DbHelperSQL.Query(sSQL);
