...
from UFDATA_100_2014..mom_order a 
    ...
    inner join UFDATA_100_2014..Inventory h on h.cInvCode = c.InvCode
where c.Status = 3 
	and a.MoCode = 'SCDD14060001' and c.SortSeq = 1
	--and isnull(d.ReportFlag,0) = 1
...
--update [SystemDB_YT].[dbo].[_TableColInfo] set TABLE_CATALOG = 'SystemDB_YT' where TABLE_CATALOG = 'SystemDB_SY' 