...
namespace MobileBaseDLL
{
    ...
    public class BaseDllMobile
    {
        ...
        /// 连接字符串
        /// </summary>
        //public static string sConnString = "uid=sa;pwd=;database=UFDATA_100_2014;server=192.168.31.206";
        //public static string sConnString = "server=192.168.1.8;uid=sa ;pwd=Sa!@#;database=UFDATA_100_2014";
        ...
        /// 第二数据库名称
        /// </summary>
        //public static string sUFDataBaseName = "UFDATA_100_2014";
