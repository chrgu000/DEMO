...
namespace MobileBaseDLL
{
    public class ClsGetSQL
    {
        ...
        protected MobileBaseDLL.ClsSQLServerCommond clsSQL = new MobileBaseDLL.ClsSQLServerCommond();
        ...
        {
            return GetDeleteSQL(MobileBaseDLL.ClsBaseDataInfo.sDataBaseName, sTableName, dtTemp, iRow);
        }
        ...
        {
            return GetUpdateSQL(MobileBaseDLL.ClsBaseDataInfo.sDataBaseName, sTableName, dtTemp, iRow);
        }
        ...
        {
            return GetInsertSQL(MobileBaseDLL.ClsBaseDataInfo.sDataBaseName, sTableName, dtTemp, iRow);
        }
