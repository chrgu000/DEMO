...
{
    /// <summary>
    /// rdrecords08:实体类(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class rdrecords08
    {
        ...
        private int _icrmvouchids;
        private string _ccrmvouchcode;
        ...
        /// 
        /// </summary>
        public int iCrmVouchids
        {
            set { _icrmvouchids = value; }
            get { return _icrmvouchids; }
        }
        /// <summary>
        /// 
        /// </summary>
        public string cCrmVouchCode
        {
            set { _ccrmvouchcode = value; }
            get { return _ccrmvouchcode; }
        }
        /// <summary>
        /// 
        /// </summary>
