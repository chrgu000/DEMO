...
namespace DllForService.DAL
{
    ...
    public partial class rdrecord32
    {
        ...
        /// 增加一条数据
        /// </summary>
        public string Add(DllForService.Model.rdrecord32 model)
        {
            ...
            if (model.cinspector != null)
            {
                strSql1.Append("cinspector,");
                strSql2.Append("'" + model.cinspector + "',");
            }
            if (model.dinspecttime != null)
            {
                strSql1.Append("dinspecttime,");
                strSql2.Append("'" + model.dinspecttime + "',");
            }
            ...
            if (model.bUpLoaded != null)
            {
                strSql1.Append("bUpLoaded,");
                strSql2.Append("" + model.bUpLoaded + ",");
            }
            if (model.outid != null)
            {
            ...
            if (model.isMDdispatch != null)
            {
                strSql1.Append("isMDdispatch,");
                strSql2.Append("" + model.isMDdispatch + ",");
            }
