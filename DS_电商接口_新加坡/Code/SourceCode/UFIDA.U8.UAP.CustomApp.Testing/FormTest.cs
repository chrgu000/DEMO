...
namespace WindowsFormsApplication1
{
    public partial class FormTest : Form
    {
        ...
        private void btnDSSaleBaseInfo_Click(object sender, EventArgs e)
        {
            FrmDSSaleBaseInfo frm = new FrmDSSaleBaseInfo();
            frm.WindowState = FormWindowState.Maximized;
            frm.ShowDialog();
        }

        private void btnRepCreateDisInfo_Click(object sender, EventArgs e)
        {
