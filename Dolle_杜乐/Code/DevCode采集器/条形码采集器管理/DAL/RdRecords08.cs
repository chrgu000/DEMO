...
namespace BarCode.DAL
{
    ...
    public partial class rdrecords08
    {
        ...
        /// 增加一条数据
        /// </summary>
        public string Add(BarCode.Model.rdrecords08 model)
        {
            ...
            if (model.iCrmVouchids != null)
            {
                strSql1.Append("iCrmVouchids,");
                strSql2.Append("" + model.iCrmVouchids + ",");
            }
            if (model.cCrmVouchCode != null)
            {
                strSql1.Append("cCrmVouchCode,");
                strSql2.Append("'" + model.cCrmVouchCode + "',");
            }
            ...
            strSql.Append("insert into @u8.rdrecords08(");
