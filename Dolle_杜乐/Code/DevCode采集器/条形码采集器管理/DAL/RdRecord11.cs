...
namespace BarCode.DAL
{
    ...
    public partial class rdrecord11
    {
        ...
        /// 增加一条数据
        /// </summary>
        public string Add(BarCode.Model.rdrecord11 model)
        {
            ...
            if (model.bmotran != null)
            {
                strSql1.Append("bmotran,");
                strSql2.Append("" + model.bmotran + ",");
            }
            ...
            if (model.bHYVouch != null)
            {
                strSql1.Append("bHYVouch,");
                strSql2.Append("" + (model.bHYVouch ? 1 : 0) + ",");
            }
            ...
            strSql.Append("insert into @u8.rdrecord11(");
