...
namespace MobileBaseDLL
{
    ...
    public class ClsBaseDataInfo
    {
        ...
        /// 连接服务器
        /// </summary>
        public static string sConnServer = "";
        ...
        /// 数据库名称
        /// </summary>
        public static string sDataBaseName = "XWSystemDB_DL";
        ...
        /// 第二数据库名称
        /// </summary>
        public static string sUFDataBaseName = "UFDATA_200_";
        ...
        /// 版本
        /// </summary>
        public static decimal sEdition = 1.00M;
        ...
        public static DateTime Get服务器时间()
        {
            try
            {
                ClsSQLServerCommond clsSQL = new ClsSQLServerCommond();
