...
{
    /// <summary>
    /// WorkGroupPeople:实体类(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class WorkGroupPeople
    {
        ...
        private string _WorkGroupPeopleno;
        private string _WorkGroupPeoplename;
        ...
        /// 
        /// </summary>
        public string WorkGroupPeopleNo
        {
            set { _WorkGroupPeopleno = value; }
            get { return _WorkGroupPeopleno; }
        }
        /// <summary>
        /// 
        /// </summary>
        public string WorkGroupPeopleName
        {
            set { _WorkGroupPeoplename = value; }
            get { return _WorkGroupPeoplename; }
        }
        /// <summary>
        /// 
        /// </summary>
